...
export default function App(){
  ...
  return(<ThemeCtx.Provider value={T}><div style={{minHeight:"100vh",background:T.bg,fontFamily:"Georgia,serif",color:T.text,transition:"background .3s,color .3s"}}>
    <div style={{background:T.headerBg,padding:"18px 12px 14px",textAlign:"center",borderBottom:"4px solid "+T.border,position:"relative"}}>
      ...
      <button onClick={toggleTheme} style={{position:"absolute",top:10,right:12,background:"rgba(244,232,209,.15)",border:"1px solid rgba(196,168,130,.3)",borderRadius:8,padding:"4px 10px",cursor:"pointer",color:T.headerText,fontSize:13,zIndex:2}} title={dark?"Switch to light mode":"Switch to dark mode"}>{dark?"☀️":"🌙"}</button>
