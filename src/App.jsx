...
const Z = [
  ...
  {id:"heart_area",label:"Patient's Left Upper Chest",x:179,y:118,r:14,anat:["Heart","Aorta","Left lung (upper)","Ribs 2-4"],sev:3,desc:"Left lung fills this space. Puncture causes lung collapse.",reg:"chest",g:"Chest"},
  ...
  {id:"ur_chest",label:"Patient's Right Upper Chest",x:111,y:118,r:14,anat:["Right lung (upper)","Collarbone blood vessels","Ribs 2-4"],sev:4,desc:"The heart and aorta sit on this side. Damage to either is almost always fatal without immediate expert intervention.",reg:"chest",g:"Chest"},
  {id:"lm_chest",label:"Patient's Left Mid Chest",x:188,y:158,r:12,anat:["Left lung (lower)","Ribs 5-8","Diaphragm (breathing muscle) edge"],sev:2,desc:"Lower right lung. Diaphragm begins here — damage affects breathing.",reg:"chest",g:"Chest"},
  {id:"rm_chest",label:"Patient's Right Mid Chest",x:102,y:158,r:12,anat:["Right lung (lower)","Ribs 5-8","Liver edge"],sev:2,desc:"Lower left lung. Diaphragm begins here — damage affects breathing.",reg:"chest",g:"Chest"},
  {id:"ll_ribs",label:"Patient's Left Lower Ribs",x:193,y:194,r:11,anat:["Floating ribs 9-12","Spleen (behind)","Diaphragm (breathing muscle)"],sev:2,desc:"Liver behind the right lower ribs. Largest internal organ, bleeds profusely when damaged.",reg:"chest",g:"Chest"},
  {id:"rl_ribs",label:"Patient's Right Lower Ribs",x:98,y:194,r:11,anat:["Floating ribs 9-12","Liver (behind)","Diaphragm (breathing muscle)"],sev:2,desc:"Floating ribs offer less protection. Spleen sits behind — blood-rich, ruptures easily.",reg:"chest",g:"Chest"},
  {id:"ul_abd",label:"Patient's Left Upper Abdomen",x:172,y:212,r:14,anat:["Spleen","Stomach","Pancreas (tail)","Left kidney (deep)"],sev:3,desc:"Dominated by the liver — massive and blood-filled. Heavy bleeding is the danger.",reg:"abdomen",g:"Abdomen"},
  {id:"ur_abd",label:"Patient's Right Upper Abdomen",x:118,y:212,r:14,anat:["Liver","Gallbladder","Right kidney (deep)","First section of small intestine"],sev:3,desc:"Spleen is fragile and blood-rich. Stomach sits centrally. Kidney tucked deep.",reg:"abdomen",g:"Abdomen"},
  {id:"c_abd",label:"Center Abdomen",x:145,y:228,r:22,anat:["Small intestine","Main artery from the heart (deep)","Main vein to the heart"],sev:2,desc:"Intestines up front. Deep behind them, the aorta and vena cava.",reg:"abdomen",g:"Abdomen"},
  {id:"ll_abd",label:"Patient's Left Lower Abdomen",x:168,y:255,r:10,anat:["Large intestine (left side)","Bladder (lower)","Left hip blood vessels"],sev:1,desc:"Appendix sits here. Intestinal damage is the main concern.",reg:"abdomen",g:"Abdomen"},
  {id:"lr_abd",label:"Patient's Right Lower Abdomen",x:122,y:255,r:10,anat:["Appendix","Large intestine (right side)","Right hip blood vessels"],sev:1,desc:"Mostly large intestine. Contents leaking into the body cavity cause deadly infection.",reg:"abdomen",g:"Abdomen"},
  {id:"groin",label:"Groin / Pelvis",x:145,y:280,r:15,anat:["Thigh artery (femoral) origin","Pelvic bones","Bladder","Nerves"],sev:3,desc:"Femoral arteries branch off here. Pelvic fractures bleed internally.",reg:"abdomen",g:"Abdomen"},
  {id:"l_shoulder",label:"Patient's Left Shoulder",bl:"Back of Left Shoulder",x:209,y:95,r:12,anat:["Shoulder joint","Collarbone","Shoulder muscle","Shoulder tendons"],sev:1,desc:"Ball-and-socket joint, prone to dislocation. Collarbone fractures easily.",reg:"leftArm",g:"Patient's Left Arm"},
  {id:"r_shoulder",label:"Patient's Right Shoulder",bl:"Back of Right Shoulder",x:84,y:95,r:12,anat:["Shoulder joint","Collarbone","Shoulder muscle","Shoulder tendons"],sev:1,desc:"Ball-and-socket joint. Collarbone fractures easily.",reg:"rightArm",g:"Patient's Right Arm"},
  {id:"l_uarm",label:"Patient's Left Upper Arm",bl:"Back of Left Upper Arm",x:226,y:147,r:12,anat:["Upper arm bone","Inner arm artery","Upper arm muscles"],sev:1,desc:"Inner arm artery runs along the inside. Arterial damage here can be serious.",reg:"leftArm",g:"Patient's Left Arm"},
  {id:"l_elbow",label:"Patient's Left Elbow",bl:"Back of Left Elbow",x:237,y:180,r:9,anat:["Elbow joint","Funny bone nerve","Inner arm artery"],sev:1,desc:"Hinge joint. Funny bone nerve at the surface. Dislocation possible.",reg:"leftArm",g:"Patient's Left Arm"},
  {id:"l_farm",label:"Patient's Left Forearm",bl:"Back of Left Forearm",x:248,y:213,r:11,anat:["Forearm bones (radius & ulna)","Wrist artery","Tendons"],sev:0,desc:"Two parallel bones. Tendon damage affects hand function.",reg:"leftArm",g:"Patient's Left Arm"},
  {id:"l_hand",label:"Patient's Left Hand (Palm)",bl:"Back of Left Hand",x:246,y:250,r:12,anat:["Hand bones","Palm tendons","Palm blood vessels"],sev:0,desc:"Complex bone and tendon structure. Defensive wounds common here.",reg:"leftArm",g:"Patient's Left Arm"},
  {id:"l_fingers",label:"Patient's Left Fingers",x:253,y:275,r:12,anat:["Finger bones","Finger tendons","Small nerves","Nail bed"],sev:0,desc:"Tiny bones connected by tendons. Loss affects dexterity permanently.",reg:"leftArm",g:"Patient's Left Arm"},
  {id:"r_uarm",label:"Patient's Right Upper Arm",bl:"Back of Right Upper Arm",x:73,y:147,r:12,anat:["Upper arm bone","Inner arm artery","Upper arm muscles"],sev:1,desc:"Inner arm artery inside. Fractures painful but survivable.",reg:"rightArm",g:"Patient's Right Arm"},
  {id:"r_elbow",label:"Patient's Right Elbow",bl:"Back of Right Elbow",x:62,y:180,r:9,anat:["Elbow joint","Funny bone nerve","Inner arm artery"],sev:1,desc:"Hinge joint. Funny bone nerve exposed. Dislocation possible.",reg:"rightArm",g:"Patient's Right Arm"},
  {id:"r_farm",label:"Patient's Right Forearm",bl:"Back of Right Forearm",x:51,y:213,r:11,anat:["Forearm bones (radius & ulna)","Wrist artery","Tendons"],sev:0,desc:"Two bones. Tendon cuts affect grip.",reg:"rightArm",g:"Patient's Right Arm"},
  {id:"r_hand",label:"Patient's Right Hand (Palm)",bl:"Back of Right Hand",x:46,y:250,r:12,anat:["Hand bones","Palm tendons","Palm blood vessels"],sev:0,desc:"Defensive wound location. Tendon/bone damage affects grip permanently.",reg:"rightArm",g:"Patient's Right Arm"},
  {id:"r_fingers",label:"Patient's Right Fingers",x:40,y:275,r:12,anat:["Finger bones","Finger tendons","Small nerves","Nail bed"],sev:0,desc:"Loss of trigger finger is significant for gunslingers.",reg:"rightArm",g:"Patient's Right Arm"},
  {id:"l_uthigh",label:"Patient's Left Upper Thigh",bl:"Back of Left Upper Thigh",x:169,y:310,r:12,anat:["Thigh artery (femoral)","Thigh vein","Thigh bone (femur)","Front thigh muscles"],sev:3,desc:"Thigh artery (femoral) — one of the largest. Damage means death in minutes.",reg:"leftLeg",g:"Patient's Left Leg"},
  {id:"l_mthigh",label:"Patient's Left Mid Thigh",bl:"Back of Left Mid Thigh",x:171,y:340,r:11,anat:["Thigh bone (femur)","Front & back thigh muscles","Deep femoral artery"],sev:1,desc:"Thick muscle around femur. GSWs can pass through without hitting bone.",reg:"leftLeg",g:"Patient's Left Leg"},
  {id:"l_knee",label:"Patient's Left Knee",bl:"Back of Left Knee",x:172,y:360,r:11,anat:["Kneecap","Knee joint & ligaments","Artery behind the knee"],sev:1,desc:"Complex joint. Knee injuries severely limit mobility.",reg:"leftLeg",g:"Patient's Left Leg"},
  {id:"l_shin",label:"Patient's Left Shin / Calf",bl:"Left Calf (Back of Shin)",x:173,y:400,r:12,anat:["Shin bone","Outer calf bone","Back of lower leg muscles"],sev:0,desc:"Shin bone right at the surface. Common fracture site.",reg:"leftLeg",g:"Patient's Left Leg"},
  {id:"l_ankle",label:"Patient's Left Ankle",bl:"Back of Left Ankle",x:171,y:452,r:8,anat:["Ankle joint","Achilles tendon (heel cord)","Side ligaments"],sev:0,desc:"Ankle sprains and fractures common. Achilles tendon is vulnerable.",reg:"leftLeg",g:"Patient's Left Leg"},
  {id:"l_foot",label:"Patient's Left Foot",bl:"Left Heel / Sole",x:174,y:472,r:10,anat:["Foot bones","Foot arch","Sole tissue"],sev:0,desc:"Many small bones. Crushing injuries painful and slow to heal.",reg:"leftLeg",g:"Patient's Left Leg"},
  {id:"l_toes",label:"Patient's Left Toes",bl:"Left Heel",x:177,y:490,r:10,anat:["Toe phalanges","Toe tendons","Small nerves"],sev:0,desc:"Tiny bones that break easily. Big toe is critical for balance.",reg:"leftLeg",g:"Patient's Left Leg"},
  {id:"r_uthigh",label:"Patient's Right Upper Thigh",bl:"Back of Right Upper Thigh",x:130,y:310,r:12,anat:["Thigh artery (femoral)","Thigh vein","Thigh bone (femur)","Front thigh muscles"],sev:3,desc:"Thigh artery (femoral) here can mean death in minutes.",reg:"rightLeg",g:"Patient's Right Leg"},
  {id:"r_mthigh",label:"Patient's Right Mid Thigh",bl:"Back of Right Mid Thigh",x:127,y:340,r:11,anat:["Thigh bone (femur)","Front & back thigh muscles","Deep femoral artery"],sev:1,desc:"Thick muscle. Less dangerous than upper thigh.",reg:"rightLeg",g:"Patient's Right Leg"},
  {id:"r_knee",label:"Patient's Right Knee",bl:"Back of Right Knee",x:125,y:360,r:11,anat:["Kneecap","Knee joint & ligaments","Artery behind the knee"],sev:1,desc:"Complex joint. Limits mobility severely.",reg:"rightLeg",g:"Patient's Right Leg"},
  {id:"r_shin",label:"Patient's Right Shin / Calf",bl:"Right Calf (Back of Shin)",x:124,y:400,r:12,anat:["Shin bone","Outer calf bone","Back of lower leg muscles"],sev:0,desc:"Shin bone close to surface. Fractures common.",reg:"rightLeg",g:"Patient's Right Leg"},
  {id:"r_ankle",label:"Patient's Right Ankle",bl:"Back of Right Ankle",x:122,y:452,r:8,anat:["Ankle joint","Achilles tendon (heel cord)","Side ligaments"],sev:0,desc:"Achilles tendon exposed at the back.",reg:"rightLeg",g:"Patient's Right Leg"},
  {id:"r_foot",label:"Patient's Right Foot",bl:"Right Heel / Sole",x:120,y:472,r:10,anat:["Foot bones","Foot arch","Sole tissue"],sev:0,desc:"Small bones, easily crushed.",reg:"rightLeg",g:"Patient's Right Leg"},
  {id:"r_toes",label:"Patient's Right Toes",bl:"Right Heel",x:117,y:490,r:10,anat:["Toe phalanges","Toe tendons","Small nerves"],sev:0,desc:"Big toe loss affects balance and gait.",reg:"rightLeg",g:"Patient's Right Leg"},
