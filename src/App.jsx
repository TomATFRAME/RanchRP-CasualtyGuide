...
const Z = [
  ...
  {id:"l_uthigh",label:"Patient's Left Upper Thigh",x:171,y:312,r:12,anat:["Thigh artery (femoral)","Thigh vein","Thigh bone (femur)","Front thigh muscles"],sev:3,desc:"Thigh artery (femoral) — one of the largest. Damage means death in minutes.",reg:"leftLeg",g:"Patient's Left Leg"},
  {id:"l_mthigh",label:"Patient's Left Mid Thigh",x:173,y:348,r:11,anat:["Thigh bone (femur)","Front & back thigh muscles","Deep femoral artery"],sev:1,desc:"Thick muscle around femur. GSWs can pass through without hitting bone.",reg:"leftLeg",g:"Patient's Left Leg"},
  {id:"l_knee",label:"Patient's Left Knee",x:172,y:380,r:9,anat:["Kneecap","Knee joint & ligaments","Artery behind the knee"],sev:1,desc:"Complex joint. Knee injuries severely limit mobility.",reg:"leftLeg",g:"Patient's Left Leg"},
  {id:"l_shin",label:"Patient's Left Shin / Calf",x:173,y:415,r:12,anat:["Shin bone","Outer calf bone","Back of lower leg muscles"],sev:0,desc:"Shin bone right at the surface. Common fracture site.",reg:"leftLeg",g:"Patient's Left Leg"},
  ...
  {id:"r_uthigh",label:"Patient's Right Upper Thigh",x:128,y:312,r:12,anat:["Thigh artery (femoral)","Thigh vein","Thigh bone (femur)","Front thigh muscles"],sev:3,desc:"Thigh artery (femoral) here can mean death in minutes.",reg:"rightLeg",g:"Patient's Right Leg"},
  {id:"r_mthigh",label:"Patient's Right Mid Thigh",x:125,y:348,r:11,anat:["Thigh bone (femur)","Front & back thigh muscles","Deep femoral artery"],sev:1,desc:"Thick muscle. Less dangerous than upper thigh.",reg:"rightLeg",g:"Patient's Right Leg"},
  {id:"r_knee",label:"Patient's Right Knee",x:123,y:380,r:9,anat:["Kneecap","Knee joint & ligaments","Artery behind the knee"],sev:1,desc:"Complex joint. Limits mobility severely.",reg:"rightLeg",g:"Patient's Right Leg"},
  {id:"r_shin",label:"Patient's Right Shin / Calf",x:122,y:415,r:12,anat:["Shin bone","Outer calf bone","Back of lower leg muscles"],sev:0,desc:"Shin bone close to surface. Fractures common.",reg:"rightLeg",g:"Patient's Right Leg"},
