...
const Z = [
  ...
  {id:"l_temple",label:"Patient's Left Temple",x:168,y:26,r:8,anat:["Temporal bone (side of skull) (thin)","Temporal artery","Brain (temporal lobe)"],sev:3,desc:"One of the thinnest skull areas. The temporal artery is just beneath. Trauma here is extremely dangerous.",reg:"head",g:"Head"},
  {id:"r_temple",label:"Patient's Right Temple",x:128,y:26,r:8,anat:["Temporal bone (side of skull) (thin)","Temporal artery","Brain (temporal lobe)"],sev:3,desc:"Thinnest skull area. Temporal artery beneath. Extremely dangerous to trauma.",reg:"head",g:"Head"},
  {id:"l_eye",label:"Patient's Left Eye",x:158,y:33,r:6,anat:["Eyeball","Optic nerve (carries vision to brain)","Orbital bone (eye socket ring)"],sev:2,desc:"The eye socket provides some bony protection, but the eye itself is extremely fragile. Damage can cause partial or total blindness.",reg:"head",g:"Head"},
  {id:"r_eye",label:"Patient's Right Eye",x:136,y:33,r:6,anat:["Eyeball","Optic nerve (carries vision to brain)","Orbital bone (eye socket ring)"],sev:2,desc:"The orbital bone shields the eye but direct trauma risks blindness.",reg:"head",g:"Head"},
  {id:"l_ear",label:"Patient's Left Ear",x:172,y:33,r:7,anat:["Ear canal","Eardrum","Inner ear (balance)"],sev:1,desc:"Outer ear tears easily and bleeds heavily. Eardrum damage from blasts or blows causes deafness or vertigo.",reg:"head",g:"Head"},
  {id:"r_ear",label:"Patient's Right Ear",x:121,y:33,r:7,anat:["Ear canal","Eardrum","Inner ear (balance)"],sev:1,desc:"Outer ear bleeds heavily when torn. Eardrum damage causes hearing loss and balance issues.",reg:"head",g:"Head"},
  ...
  {id:"c_abd",label:"Center Abdomen",x:145,y:225,r:16,anat:["Small intestine","Main artery from the heart (deep)","Main vein to the heart"],sev:2,desc:"Intestines up front. Deep behind them, the aorta and vena cava.",reg:"abdomen",g:"Abdomen"},
  {id:"ll_abd",label:"Patient's Left Lower Abdomen",x:166,y:267,r:11,anat:["Large intestine (left side)","Bladder (lower)","Left hip blood vessels"],sev:1,desc:"Appendix sits here. Intestinal damage is the main concern.",reg:"abdomen",g:"Abdomen"},
  {id:"lr_abd",label:"Patient's Right Lower Abdomen",x:124,y:267,r:11,anat:["Appendix","Large intestine (right side)","Right hip blood vessels"],sev:1,desc:"Mostly large intestine. Contents leaking into the body cavity cause deadly infection.",reg:"abdomen",g:"Abdomen"},
  ...
  {id:"l_shoulder",label:"Patient's Left Shoulder",x:209,y:95,r:12,anat:["Shoulder joint","Collarbone","Shoulder muscle","Shoulder tendons"],sev:1,desc:"Ball-and-socket joint, prone to dislocation. Collarbone fractures easily.",reg:"leftArm",g:"Patient's Left Arm"},
  {id:"r_shoulder",label:"Patient's Right Shoulder",x:84,y:95,r:12,anat:["Shoulder joint","Collarbone","Shoulder muscle","Shoulder tendons"],sev:1,desc:"Ball-and-socket joint. Collarbone fractures easily.",reg:"rightArm",g:"Patient's Right Arm"},
  {id:"l_uarm",label:"Patient's Left Upper Arm",x:226,y:147,r:12,anat:["Upper arm bone","Inner arm artery","Upper arm muscles"],sev:1,desc:"Inner arm artery runs along the inside. Arterial damage here can be serious.",reg:"leftArm",g:"Patient's Left Arm"},
  {id:"l_elbow",label:"Patient's Left Elbow",x:237,y:180,r:9,anat:["Elbow joint","Funny bone nerve","Inner arm artery"],sev:1,desc:"Hinge joint. Funny bone nerve at the surface. Dislocation possible.",reg:"leftArm",g:"Patient's Left Arm"},
  {id:"l_farm",label:"Patient's Left Forearm",x:248,y:213,r:11,anat:["Forearm bones (radius & ulna)","Wrist artery","Tendons"],sev:0,desc:"Two parallel bones. Tendon damage affects hand function.",reg:"leftArm",g:"Patient's Left Arm"},
  {id:"l_hand",label:"Patient's Left Hand (Palm)",x:246,y:250,r:12,anat:["Hand bones","Palm tendons","Palm blood vessels"],sev:0,desc:"Complex bone and tendon structure. Defensive wounds common here.",reg:"leftArm",g:"Patient's Left Arm"},
  ...
  {id:"r_uarm",label:"Patient's Right Upper Arm",x:73,y:147,r:12,anat:["Upper arm bone","Inner arm artery","Upper arm muscles"],sev:1,desc:"Inner arm artery inside. Fractures painful but survivable.",reg:"rightArm",g:"Patient's Right Arm"},
  {id:"r_elbow",label:"Patient's Right Elbow",x:62,y:180,r:9,anat:["Elbow joint","Funny bone nerve","Inner arm artery"],sev:1,desc:"Hinge joint. Funny bone nerve exposed. Dislocation possible.",reg:"rightArm",g:"Patient's Right Arm"},
  {id:"r_farm",label:"Patient's Right Forearm",x:51,y:213,r:11,anat:["Forearm bones (radius & ulna)","Wrist artery","Tendons"],sev:0,desc:"Two bones. Tendon cuts affect grip.",reg:"rightArm",g:"Patient's Right Arm"},
  {id:"r_hand",label:"Patient's Right Hand (Palm)",x:46,y:250,r:12,anat:["Hand bones","Palm tendons","Palm blood vessels"],sev:0,desc:"Defensive wound location. Tendon/bone damage affects grip permanently.",reg:"rightArm",g:"Patient's Right Arm"},
  ...
  {id:"l_uthigh",label:"Patient's Left Upper Thigh",x:171,y:327,r:12,anat:["Thigh artery (femoral)","Thigh vein","Thigh bone (femur)","Front thigh muscles"],sev:3,desc:"Thigh artery (femoral) — one of the largest. Damage means death in minutes.",reg:"leftLeg",g:"Patient's Left Leg"},
  {id:"l_mthigh",label:"Patient's Left Mid Thigh",x:173,y:365,r:11,anat:["Thigh bone (femur)","Front & back thigh muscles","Deep femoral artery"],sev:1,desc:"Thick muscle around femur. GSWs can pass through without hitting bone.",reg:"leftLeg",g:"Patient's Left Leg"},
  {id:"l_knee",label:"Patient's Left Knee",x:172,y:398,r:9,anat:["Kneecap","Knee joint & ligaments","Artery behind the knee"],sev:1,desc:"Complex joint. Knee injuries severely limit mobility.",reg:"leftLeg",g:"Patient's Left Leg"},
  {id:"l_shin",label:"Patient's Left Shin / Calf",x:173,y:436,r:12,anat:["Shin bone","Outer calf bone","Back of lower leg muscles"],sev:0,desc:"Shin bone right at the surface. Common fracture site.",reg:"leftLeg",g:"Patient's Left Leg"},
  {id:"l_ankle",label:"Patient's Left Ankle",x:171,y:471,r:8,anat:["Ankle joint","Achilles tendon (heel cord)","Side ligaments"],sev:0,desc:"Ankle sprains and fractures common. Achilles tendon is vulnerable.",reg:"leftLeg",g:"Patient's Left Leg"},
  {id:"l_foot",label:"Patient's Left Foot",x:174,y:488,r:10,anat:["Foot bones","Foot arch","Sole tissue"],sev:0,desc:"Many small bones. Crushing injuries painful and slow to heal.",reg:"leftLeg",g:"Patient's Left Leg"},
  {id:"l_toes",label:"Patient's Left Toes",x:177,y:500,r:10,anat:["Toe phalanges","Toe tendons","Small nerves"],sev:0,desc:"Tiny bones that break easily. Big toe is critical for balance.",reg:"leftLeg",g:"Patient's Left Leg"},
  {id:"r_uthigh",label:"Patient's Right Upper Thigh",x:128,y:327,r:12,anat:["Thigh artery (femoral)","Thigh vein","Thigh bone (femur)","Front thigh muscles"],sev:3,desc:"Thigh artery (femoral) here can mean death in minutes.",reg:"rightLeg",g:"Patient's Right Leg"},
  {id:"r_mthigh",label:"Patient's Right Mid Thigh",x:125,y:365,r:11,anat:["Thigh bone (femur)","Front & back thigh muscles","Deep femoral artery"],sev:1,desc:"Thick muscle. Less dangerous than upper thigh.",reg:"rightLeg",g:"Patient's Right Leg"},
  {id:"r_knee",label:"Patient's Right Knee",x:123,y:398,r:9,anat:["Kneecap","Knee joint & ligaments","Artery behind the knee"],sev:1,desc:"Complex joint. Limits mobility severely.",reg:"rightLeg",g:"Patient's Right Leg"},
  {id:"r_shin",label:"Patient's Right Shin / Calf",x:122,y:436,r:12,anat:["Shin bone","Outer calf bone","Back of lower leg muscles"],sev:0,desc:"Shin bone close to surface. Fractures common.",reg:"rightLeg",g:"Patient's Right Leg"},
  {id:"r_ankle",label:"Patient's Right Ankle",x:122,y:471,r:8,anat:["Ankle joint","Achilles tendon (heel cord)","Side ligaments"],sev:0,desc:"Achilles tendon exposed at the back.",reg:"rightLeg",g:"Patient's Right Leg"},
  {id:"r_foot",label:"Patient's Right Foot",x:120,y:488,r:10,anat:["Foot bones","Foot arch","Sole tissue"],sev:0,desc:"Small bones, easily crushed.",reg:"rightLeg",g:"Patient's Right Leg"},
    ...
    <div style={{padding:"12px 10px 80px"}}>
      ...
      {has&&tab==="injuries"&&(<div style={{background:T.bgCard,border:"2px solid "+T.border,borderRadius:12,padding:"14px 11px",boxShadow:"0 2px 8px rgba(61,43,31,.06)"}}>
        ...
        {val.map((inj,i)=>{const zone=Z.find(z=>z.id===inj.zid);const data=OD[inj.type];if(!data||!zone)return null;
          ...
          const sv=oSv||Math.min(5,Math.max(1,(IT[inj.type]&&IT[inj.type].bs||1)+(zone.sev||0)+(wm&&wm.sevMod||0)+(idmg&&iSev>=3?1:0)));const si=SV[Math.min(Math.max(sv,1),5)-1]||SV[0];
