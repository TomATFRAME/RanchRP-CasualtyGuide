...
const Z = [
  ...
  {id:"ll_abd",label:"Patient's Left Lower Abdomen",x:168,y:262,r:10,anat:["Large intestine (left side)","Bladder (lower)","Left hip blood vessels"],sev:1,desc:"Appendix sits here. Intestinal damage is the main concern.",reg:"abdomen",g:"Abdomen"},
  {id:"lr_abd",label:"Patient's Right Lower Abdomen",x:122,y:262,r:10,anat:["Appendix","Large intestine (right side)","Right hip blood vessels"],sev:1,desc:"Mostly large intestine. Contents leaking into the body cavity cause deadly infection.",reg:"abdomen",g:"Abdomen"},
  ...
  {id:"l_uthigh",label:"Patient's Left Upper Thigh",x:169,y:310,r:12,anat:["Thigh artery (femoral)","Thigh vein","Thigh bone (femur)","Front thigh muscles"],sev:3,desc:"Thigh artery (femoral) — one of the largest. Damage means death in minutes.",reg:"leftLeg",g:"Patient's Left Leg"},
  {id:"l_mthigh",label:"Patient's Left Mid Thigh",x:171,y:340,r:11,anat:["Thigh bone (femur)","Front & back thigh muscles","Deep femoral artery"],sev:1,desc:"Thick muscle around femur. GSWs can pass through without hitting bone.",reg:"leftLeg",g:"Patient's Left Leg"},
  {id:"l_knee",label:"Patient's Left Knee",x:172,y:360,r:11,anat:["Kneecap","Knee joint & ligaments","Artery behind the knee"],sev:1,desc:"Complex joint. Knee injuries severely limit mobility.",reg:"leftLeg",g:"Patient's Left Leg"},
  {id:"l_shin",label:"Patient's Left Shin / Calf",x:173,y:400,r:12,anat:["Shin bone","Outer calf bone","Back of lower leg muscles"],sev:0,desc:"Shin bone right at the surface. Common fracture site.",reg:"leftLeg",g:"Patient's Left Leg"},
  {id:"l_ankle",label:"Patient's Left Ankle",x:171,y:452,r:8,anat:["Ankle joint","Achilles tendon (heel cord)","Side ligaments"],sev:0,desc:"Ankle sprains and fractures common. Achilles tendon is vulnerable.",reg:"leftLeg",g:"Patient's Left Leg"},
  {id:"l_foot",label:"Patient's Left Foot",x:174,y:472,r:10,anat:["Foot bones","Foot arch","Sole tissue"],sev:0,desc:"Many small bones. Crushing injuries painful and slow to heal.",reg:"leftLeg",g:"Patient's Left Leg"},
  ...
  {id:"r_uthigh",label:"Patient's Right Upper Thigh",x:130,y:310,r:12,anat:["Thigh artery (femoral)","Thigh vein","Thigh bone (femur)","Front thigh muscles"],sev:3,desc:"Thigh artery (femoral) here can mean death in minutes.",reg:"rightLeg",g:"Patient's Right Leg"},
  {id:"r_mthigh",label:"Patient's Right Mid Thigh",x:127,y:340,r:11,anat:["Thigh bone (femur)","Front & back thigh muscles","Deep femoral artery"],sev:1,desc:"Thick muscle. Less dangerous than upper thigh.",reg:"rightLeg",g:"Patient's Right Leg"},
  {id:"r_knee",label:"Patient's Right Knee",x:125,y:360,r:11,anat:["Kneecap","Knee joint & ligaments","Artery behind the knee"],sev:1,desc:"Complex joint. Limits mobility severely.",reg:"rightLeg",g:"Patient's Right Leg"},
  {id:"r_shin",label:"Patient's Right Shin / Calf",x:124,y:400,r:12,anat:["Shin bone","Outer calf bone","Back of lower leg muscles"],sev:0,desc:"Shin bone close to surface. Fractures common.",reg:"rightLeg",g:"Patient's Right Leg"},
  {id:"r_ankle",label:"Patient's Right Ankle",x:122,y:452,r:8,anat:["Ankle joint","Achilles tendon (heel cord)","Side ligaments"],sev:0,desc:"Achilles tendon exposed at the back.",reg:"rightLeg",g:"Patient's Right Leg"},
  {id:"r_foot",label:"Patient's Right Foot",x:120,y:472,r:10,anat:["Foot bones","Foot arch","Sole tissue"],sev:0,desc:"Small bones, easily crushed.",reg:"rightLeg",g:"Patient's Right Leg"},
