...
const Z = [
  ...
  {id:"c_abd",label:"Center Abdomen",x:145,y:238,r:20,anat:["Small intestine","Main artery from the heart (deep)","Main vein to the heart"],sev:2,desc:"Intestines up front. Deep behind them, the aorta and vena cava.",reg:"abdomen",g:"Abdomen"},
