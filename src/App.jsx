...
// ═══════════════════════════════════════════════════════════════════════════════
const Z = [
  {id:"crown",label:"Top of Head",x:124,y:6,r:14,anat:["Parietal bone (top of skull)","Brain (parietal lobe)"],sev:2,desc:"Thick bone but blunt force causes concussions. Scalp bleeds heavily — very vascular.",reg:"head",g:"Head"},
  {id:"forehead",label:"Forehead",x:122,y:20,r:12,anat:["Frontal bone (forehead plate) (thick)","Brain (frontal lobe)"],sev:2,desc:"Relatively thick bone offering decent protection, but hard hits fracture it or concuss the brain beneath.",reg:"head",g:"Head",fo:true},
  {id:"l_temple",label:"Patient's Left Temple",x:142,y:25,r:9,anat:["Temporal bone (side of skull) (thin)","Temporal artery","Brain (temporal lobe)"],sev:3,desc:"One of the thinnest skull areas. The temporal artery is just beneath. Trauma here is extremely dangerous.",reg:"head",g:"Head",fo:true},
  {id:"r_temple",label:"Patient's Right Temple",x:102,y:25,r:9,anat:["Temporal bone (side of skull) (thin)","Temporal artery","Brain (temporal lobe)"],sev:3,desc:"Thinnest skull area. Temporal artery beneath. Extremely dangerous to trauma.",reg:"head",g:"Head",fo:true},
  {id:"l_eye",label:"Patient's Left Eye",x:132,y:32,r:7,anat:["Eyeball","Optic nerve (carries vision to brain)","Orbital bone (eye socket ring)"],sev:2,desc:"The eye socket provides some bony protection, but the eye itself is extremely fragile. Damage can cause partial or total blindness.",reg:"head",g:"Head",fo:true},
  {id:"r_eye",label:"Patient's Right Eye",x:110,y:32,r:7,anat:["Eyeball","Optic nerve (carries vision to brain)","Orbital bone (eye socket ring)"],sev:2,desc:"The orbital bone shields the eye but direct trauma risks blindness.",reg:"head",g:"Head",fo:true},
  {id:"l_ear",label:"Patient's Left Ear",x:147,y:32,r:7,anat:["Ear canal","Eardrum","Inner ear (balance)"],sev:1,desc:"Outer ear tears easily and bleeds heavily. Eardrum damage from blasts or blows causes deafness or vertigo.",reg:"head",g:"Head"},
  {id:"r_ear",label:"Patient's Right Ear",x:95,y:32,r:7,anat:["Ear canal","Eardrum","Inner ear (balance)"],sev:1,desc:"Outer ear bleeds heavily when torn. Eardrum damage causes hearing loss and balance issues.",reg:"head",g:"Head"},
  {id:"nose",label:"Nose",x:121,y:41,r:7,anat:["Nasal bone (thin)","Nose cartilage (flexible part)","Sinuses","Blood vessels (rich supply)"],sev:1,desc:"The nasal bone breaks easily — one of the most common facial fractures. Bleeds heavily due to rich blood supply.",reg:"head",g:"Head",fo:true},
  {id:"mouth",label:"Mouth / Jaw",x:120,y:51,r:7,anat:["Jawbone","Teeth","Tongue","Oral blood vessels"],sev:1,desc:"The jaw can fracture or dislocate. Teeth can be knocked out or shattered.",reg:"head",g:"Head",fo:true},
  {id:"chin",label:"Chin",x:120,y:59,r:6,anat:["Mandible (jawbone tip)","Chin muscle"],sev:1,desc:"A hard hit to the chin transmits force into the jaw joint and skull, causing a knockout or concussion.",reg:"head",g:"Head",fo:true},
  {id:"back_of_head",label:"Back of Head",x:122,y:28,r:16,anat:["Occipital bone (back of skull)","Brain (occipital lobe — vision)","Brainstem (deep)"],sev:3,desc:"The occipital bone is thick but a hard blow here can cause concussion, vision problems, or brainstem damage. Falls often land here.",reg:"head",g:"Head",bo:true},
