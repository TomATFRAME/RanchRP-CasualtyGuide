...
// ═══════════════════════════════════════════════════════════════════════════════
const Z = [
  {id:"crown",label:"Top of Head",x:121,y:4,r:10,anat:["Parietal bone (top of skull)","Brain (parietal lobe)"],sev:2,desc:"Thick bone but blunt force causes concussions. Scalp bleeds heavily — very vascular.",reg:"head",g:"Head"},
  {id:"forehead",label:"Forehead",x:121,y:18,r:8,anat:["Frontal bone (forehead plate) (thick)","Brain (frontal lobe)"],sev:2,desc:"Relatively thick bone offering decent protection, but hard hits fracture it or concuss the brain beneath.",reg:"head",g:"Head",fo:true},
  {id:"l_temple",label:"Patient's Left Temple",x:140,y:24,r:6,anat:["Temporal bone (side of skull) (thin)","Temporal artery","Brain (temporal lobe)"],sev:3,desc:"One of the thinnest skull areas. The temporal artery is just beneath. Trauma here is extremely dangerous.",reg:"head",g:"Head",fo:true},
  {id:"r_temple",label:"Patient's Right Temple",x:102,y:24,r:6,anat:["Temporal bone (side of skull) (thin)","Temporal artery","Brain (temporal lobe)"],sev:3,desc:"Thinnest skull area. Temporal artery beneath. Extremely dangerous to trauma.",reg:"head",g:"Head",fo:true},
  {id:"l_eye",label:"Patient's Left Eye",x:130,y:31,r:5,anat:["Eyeball","Optic nerve (carries vision to brain)","Orbital bone (eye socket ring)"],sev:2,desc:"The eye socket provides some bony protection, but the eye itself is extremely fragile. Damage can cause partial or total blindness.",reg:"head",g:"Head",fo:true},
  {id:"r_eye",label:"Patient's Right Eye",x:112,y:31,r:5,anat:["Eyeball","Optic nerve (carries vision to brain)","Orbital bone (eye socket ring)"],sev:2,desc:"The orbital bone shields the eye but direct trauma risks blindness.",reg:"head",g:"Head",fo:true},
  {id:"l_ear",label:"Patient's Left Ear",x:148,y:31,r:5,anat:["Ear canal","Eardrum","Inner ear (balance)"],sev:1,desc:"Outer ear tears easily and bleeds heavily. Eardrum damage from blasts or blows causes deafness or vertigo.",reg:"head",g:"Head"},
  {id:"r_ear",label:"Patient's Right Ear",x:94,y:31,r:5,anat:["Ear canal","Eardrum","Inner ear (balance)"],sev:1,desc:"Outer ear bleeds heavily when torn. Eardrum damage causes hearing loss and balance issues.",reg:"head",g:"Head"},
  {id:"nose",label:"Nose",x:121,y:39,r:5,anat:["Nasal bone (thin)","Nose cartilage (flexible part)","Sinuses","Blood vessels (rich supply)"],sev:1,desc:"The nasal bone breaks easily — one of the most common facial fractures. Bleeds heavily due to rich blood supply.",reg:"head",g:"Head",fo:true},
  {id:"mouth",label:"Mouth / Jaw",x:121,y:48,r:5,anat:["Jawbone","Teeth","Tongue","Oral blood vessels"],sev:1,desc:"The jaw can fracture or dislocate. Teeth can be knocked out or shattered.",reg:"head",g:"Head",fo:true},
  {id:"chin",label:"Chin",x:121,y:56,r:5,anat:["Mandible (jawbone tip)","Chin muscle"],sev:1,desc:"A hard hit to the chin transmits force into the jaw joint and skull, causing a knockout or concussion.",reg:"head",g:"Head",fo:true},
  {id:"back_of_head",label:"Back of Head",x:121,y:25,r:14,anat:["Occipital bone (back of skull)","Brain (occipital lobe — vision)","Brainstem (deep)"],sev:3,desc:"The occipital bone is thick but a hard blow here can cause concussion, vision problems, or brainstem damage. Falls often land here.",reg:"head",g:"Head",bo:true},
  {id:"l_neck",label:"Patient's Left Neck",x:131,y:72,r:6,anat:["Left carotid artery","Left jugular vein","Neck vertebrae (spine)"],sev:4,desc:"Carotid carries blood to the brain — severing it means death in minutes.",reg:"neck",g:"Neck"},
  {id:"r_neck",label:"Patient's Right Neck",x:108,y:72,r:6,anat:["Right carotid artery","Right jugular vein","Neck vertebrae (spine)"],sev:4,desc:"Carotid and jugular critically exposed. Spinal damage at this level can mean paralysis or death.",reg:"neck",g:"Neck"},
  {id:"throat",label:"Throat",x:119,y:75,r:5,anat:["Windpipe","Food pipe","Thyroid"],sev:3,desc:"Windpipe sits right at the surface with almost no protection.",reg:"neck",g:"Neck"},
  {id:"heart_area",label:"Patient's Left Upper Chest",x:150,y:108,r:13,anat:["Heart","Aorta","Left lung (upper)","Ribs 2-4"],sev:3,desc:"Left lung fills this space. Puncture causes lung collapse.",reg:"chest",g:"Chest"},
  {id:"sternum",label:"Breastbone",x:119,y:110,r:9,anat:["Breastbone","Heart (behind)","Major vessels"],sev:3,desc:"Flat bone shielding the heart. A bullet punches through into the heart.",reg:"chest",g:"Chest"},
  {id:"ur_chest",label:"Patient's Right Upper Chest",x:88,y:108,r:13,anat:["Right lung (upper)","Collarbone blood vessels","Ribs 2-4"],sev:4,desc:"The heart and aorta sit on this side. Damage to either is almost always fatal without immediate expert intervention.",reg:"chest",g:"Chest"},
  {id:"lm_chest",label:"Patient's Left Mid Chest",x:159,y:145,r:11,anat:["Left lung (lower)","Ribs 5-8","Diaphragm (breathing muscle) edge"],sev:2,desc:"Lower right lung. Diaphragm begins here — damage affects breathing.",reg:"chest",g:"Chest"},
  {id:"rm_chest",label:"Patient's Right Mid Chest",x:80,y:145,r:11,anat:["Right lung (lower)","Ribs 5-8","Liver edge"],sev:2,desc:"Lower left lung. Diaphragm begins here — damage affects breathing.",reg:"chest",g:"Chest"},
  {id:"ll_ribs",label:"Patient's Left Lower Ribs",x:163,y:178,r:10,anat:["Floating ribs 9-12","Spleen (behind)","Diaphragm (breathing muscle)"],sev:2,desc:"Liver behind the right lower ribs. Largest internal organ, bleeds profusely when damaged.",reg:"chest",g:"Chest"},
  {id:"rl_ribs",label:"Patient's Right Lower Ribs",x:76,y:178,r:10,anat:["Floating ribs 9-12","Liver (behind)","Diaphragm (breathing muscle)"],sev:2,desc:"Floating ribs offer less protection. Spleen sits behind — blood-rich, ruptures easily.",reg:"chest",g:"Chest"},
  {id:"ul_abd",label:"Patient's Left Upper Abdomen",x:144,y:195,r:13,anat:["Spleen","Stomach","Pancreas (tail)","Left kidney (deep)"],sev:3,desc:"Dominated by the liver — massive and blood-filled. Heavy bleeding is the danger.",reg:"abdomen",g:"Abdomen"},
  {id:"ur_abd",label:"Patient's Right Upper Abdomen",x:95,y:195,r:13,anat:["Liver","Gallbladder","Right kidney (deep)","First section of small intestine"],sev:3,desc:"Spleen is fragile and blood-rich. Stomach sits centrally. Kidney tucked deep.",reg:"abdomen",g:"Abdomen"},
  {id:"c_abd",label:"Center Abdomen",x:119,y:209,r:18,anat:["Small intestine","Main artery from the heart (deep)","Main vein to the heart"],sev:2,desc:"Intestines up front. Deep behind them, the aorta and vena cava.",reg:"abdomen",g:"Abdomen"},
  {id:"ll_abd",label:"Patient's Left Lower Abdomen",x:140,y:234,r:9,anat:["Large intestine (left side)","Bladder (lower)","Left hip blood vessels"],sev:1,desc:"Appendix sits here. Intestinal damage is the main concern.",reg:"abdomen",g:"Abdomen"},
  {id:"lr_abd",label:"Patient's Right Lower Abdomen",x:98,y:234,r:9,anat:["Appendix","Large intestine (right side)","Right hip blood vessels"],sev:1,desc:"Mostly large intestine. Contents leaking into the body cavity cause deadly infection.",reg:"abdomen",g:"Abdomen"},
  {id:"groin",label:"Groin / Pelvis",x:119,y:257,r:13,anat:["Thigh artery (femoral) origin","Pelvic bones","Bladder","Nerves"],sev:3,desc:"Femoral arteries branch off here. Pelvic fractures bleed internally.",reg:"abdomen",g:"Abdomen"},
  {id:"l_shoulder",label:"Patient's Left Shoulder",bl:"Back of Left Shoulder",x:178,y:87,r:11,anat:["Shoulder joint","Collarbone","Shoulder muscle","Shoulder tendons"],sev:1,desc:"Ball-and-socket joint, prone to dislocation. Collarbone fractures easily.",reg:"leftArm",g:"Patient's Left Arm"},
  {id:"r_shoulder",label:"Patient's Right Shoulder",bl:"Back of Right Shoulder",x:63,y:87,r:11,anat:["Shoulder joint","Collarbone","Shoulder muscle","Shoulder tendons"],sev:1,desc:"Ball-and-socket joint. Collarbone fractures easily.",reg:"rightArm",g:"Patient's Right Arm"},
  {id:"l_uarm",label:"Patient's Left Upper Arm",bl:"Back of Left Upper Arm",x:194,y:135,r:11,anat:["Upper arm bone","Inner arm artery","Upper arm muscles"],sev:1,desc:"Inner arm artery runs along the inside. Arterial damage here can be serious.",reg:"leftArm",g:"Patient's Left Arm"},
  {id:"l_elbow",label:"Patient's Left Elbow",bl:"Back of Left Elbow",x:204,y:165,r:8,anat:["Elbow joint","Funny bone nerve","Inner arm artery"],sev:1,desc:"Hinge joint. Funny bone nerve at the surface. Dislocation possible.",reg:"leftArm",g:"Patient's Left Arm"},
  {id:"l_farm",label:"Patient's Left Forearm",bl:"Back of Left Forearm",x:214,y:195,r:10,anat:["Forearm bones (radius & ulna)","Wrist artery","Tendons"],sev:0,desc:"Two parallel bones. Tendon damage affects hand function.",reg:"leftArm",g:"Patient's Left Arm"},
  {id:"l_hand",label:"Patient's Left Hand (Palm)",bl:"Back of Left Hand",x:212,y:229,r:11,anat:["Hand bones","Palm tendons","Palm blood vessels"],sev:0,desc:"Complex bone and tendon structure. Defensive wounds common here.",reg:"leftArm",g:"Patient's Left Arm"},
  {id:"l_fingers",label:"Patient's Left Fingers",x:218,y:252,r:11,anat:["Finger bones","Finger tendons","Small nerves","Nail bed"],sev:0,desc:"Tiny bones connected by tendons. Loss affects dexterity permanently.",reg:"leftArm",g:"Patient's Left Arm"},
  {id:"r_uarm",label:"Patient's Right Upper Arm",bl:"Back of Right Upper Arm",x:53,y:135,r:11,anat:["Upper arm bone","Inner arm artery","Upper arm muscles"],sev:1,desc:"Inner arm artery inside. Fractures painful but survivable.",reg:"rightArm",g:"Patient's Right Arm"},
  {id:"r_elbow",label:"Patient's Right Elbow",bl:"Back of Right Elbow",x:43,y:165,r:8,anat:["Elbow joint","Funny bone nerve","Inner arm artery"],sev:1,desc:"Hinge joint. Funny bone nerve exposed. Dislocation possible.",reg:"rightArm",g:"Patient's Right Arm"},
  {id:"r_farm",label:"Patient's Right Forearm",bl:"Back of Right Forearm",x:33,y:195,r:10,anat:["Forearm bones (radius & ulna)","Wrist artery","Tendons"],sev:0,desc:"Two bones. Tendon cuts affect grip.",reg:"rightArm",g:"Patient's Right Arm"},
  {id:"r_hand",label:"Patient's Right Hand (Palm)",bl:"Back of Right Hand",x:28,y:229,r:11,anat:["Hand bones","Palm tendons","Palm blood vessels"],sev:0,desc:"Defensive wound location. Tendon/bone damage affects grip permanently.",reg:"rightArm",g:"Patient's Right Arm"},
  {id:"r_fingers",label:"Patient's Right Fingers",x:23,y:252,r:11,anat:["Finger bones","Finger tendons","Small nerves","Nail bed"],sev:0,desc:"Loss of trigger finger is significant for gunslingers.",reg:"rightArm",g:"Patient's Right Arm"},
  {id:"l_uthigh",label:"Patient's Left Upper Thigh",bl:"Back of Left Upper Thigh",x:141,y:284,r:11,anat:["Thigh artery (femoral)","Thigh vein","Thigh bone (femur)","Front thigh muscles"],sev:3,desc:"Thigh artery (femoral) — one of the largest. Damage means death in minutes.",reg:"leftLeg",g:"Patient's Left Leg"},
  {id:"l_mthigh",label:"Patient's Left Mid Thigh",bl:"Back of Left Mid Thigh",x:143,y:312,r:10,anat:["Thigh bone (femur)","Front & back thigh muscles","Deep femoral artery"],sev:1,desc:"Thick muscle around femur. GSWs can pass through without hitting bone.",reg:"leftLeg",g:"Patient's Left Leg"},
  {id:"l_knee",label:"Patient's Left Knee",bl:"Back of Left Knee",x:144,y:330,r:10,anat:["Kneecap","Knee joint & ligaments","Artery behind the knee"],sev:1,desc:"Complex joint. Knee injuries severely limit mobility.",reg:"leftLeg",g:"Patient's Left Leg"},
  {id:"l_shin",label:"Patient's Left Shin / Calf",bl:"Left Calf (Back of Shin)",x:145,y:367,r:11,anat:["Shin bone","Outer calf bone","Back of lower leg muscles"],sev:0,desc:"Shin bone right at the surface. Common fracture site.",reg:"leftLeg",g:"Patient's Left Leg"},
  {id:"l_ankle",label:"Patient's Left Ankle",bl:"Back of Left Ankle",x:143,y:415,r:7,anat:["Ankle joint","Achilles tendon (heel cord)","Side ligaments"],sev:0,desc:"Ankle sprains and fractures common. Achilles tendon is vulnerable.",reg:"leftLeg",g:"Patient's Left Leg"},
  {id:"l_foot",label:"Patient's Left Foot",bl:"Left Heel / Sole",x:146,y:433,r:9,anat:["Foot bones","Foot arch","Sole tissue"],sev:0,desc:"Many small bones. Crushing injuries painful and slow to heal.",reg:"leftLeg",g:"Patient's Left Leg"},
  {id:"l_toes",label:"Patient's Left Toes",bl:"Left Heel",x:149,y:450,r:9,anat:["Toe phalanges","Toe tendons","Small nerves"],sev:0,desc:"Tiny bones that break easily. Big toe is critical for balance.",reg:"leftLeg",g:"Patient's Left Leg"},
  {id:"r_uthigh",label:"Patient's Right Upper Thigh",bl:"Back of Right Upper Thigh",x:106,y:284,r:11,anat:["Thigh artery (femoral)","Thigh vein","Thigh bone (femur)","Front thigh muscles"],sev:3,desc:"Thigh artery (femoral) here can mean death in minutes.",reg:"rightLeg",g:"Patient's Right Leg"},
  {id:"r_mthigh",label:"Patient's Right Mid Thigh",bl:"Back of Right Mid Thigh",x:103,y:312,r:10,anat:["Thigh bone (femur)","Front & back thigh muscles","Deep femoral artery"],sev:1,desc:"Thick muscle. Less dangerous than upper thigh.",reg:"rightLeg",g:"Patient's Right Leg"},
  {id:"r_knee",label:"Patient's Right Knee",bl:"Back of Right Knee",x:101,y:330,r:10,anat:["Kneecap","Knee joint & ligaments","Artery behind the knee"],sev:1,desc:"Complex joint. Limits mobility severely.",reg:"rightLeg",g:"Patient's Right Leg"},
  {id:"r_shin",label:"Patient's Right Shin / Calf",bl:"Right Calf (Back of Shin)",x:100,y:367,r:11,anat:["Shin bone","Outer calf bone","Back of lower leg muscles"],sev:0,desc:"Shin bone close to surface. Fractures common.",reg:"rightLeg",g:"Patient's Right Leg"},
  {id:"r_ankle",label:"Patient's Right Ankle",bl:"Back of Right Ankle",x:98,y:415,r:7,anat:["Ankle joint","Achilles tendon (heel cord)","Side ligaments"],sev:0,desc:"Achilles tendon exposed at the back.",reg:"rightLeg",g:"Patient's Right Leg"},
  {id:"r_foot",label:"Patient's Right Foot",bl:"Right Heel / Sole",x:96,y:433,r:9,anat:["Foot bones","Foot arch","Sole tissue"],sev:0,desc:"Small bones, easily crushed.",reg:"rightLeg",g:"Patient's Right Leg"},
  {id:"r_toes",label:"Patient's Right Toes",bl:"Right Heel",x:94,y:450,r:9,anat:["Toe phalanges","Toe tendons","Small nerves"],sev:0,desc:"Big toe loss affects balance and gait.",reg:"rightLeg",g:"Patient's Right Leg"},
  {id:"u_back",label:"Upper Back",x:119,y:110,r:15,anat:["Upper spine","Spinal cord","Shoulder blades","Lungs (behind ribs)"],sev:3,desc:"Spinal cord here — damage means paralysis.",reg:"back",g:"Back",bo:true},
  {id:"m_back",label:"Mid Back",x:119,y:160,r:15,anat:["Upper and lower spine","Spinal cord","Kidneys (flanks)","Rear ribs"],sev:3,desc:"Kidneys on either side — blood-rich, vulnerable from behind.",reg:"back",g:"Back",bo:true},
  {id:"lo_back",label:"Lower Back",x:119,y:204,r:13,anat:["Lower spine","Spinal nerves","Major back muscles"],sev:2,desc:"Lower spine bears most body weight. Nerve damage affects legs.",reg:"back",g:"Back",bo:true},
  {id:"l_buttock",label:"Patient's Left Buttock",x:140,y:252,r:15,anat:["Gluteal muscles (large)","Sciatic nerve (deep)","Pelvic bone"],sev:0,desc:"Thick muscle protects the sciatic nerve and pelvis. Painful but rarely life-threatening. GSWs can hit the sciatic nerve causing leg numbness.",reg:"back",g:"Back",bo:true},
  {id:"r_buttock",label:"Patient's Right Buttock",x:98,y:252,r:15,anat:["Gluteal muscles (large)","Sciatic nerve (deep)","Pelvic bone"],sev:0,desc:"Heavy muscle mass absorbs impact well. Sciatic nerve damage causes shooting pain and leg weakness.",reg:"back",g:"Back",bo:true},
];
...
const IT = {
  ...
  stab_wound:{l:"Stab / Knife / Arrow",i:"🗡️",bs:2},burn_1:{l:"Burn — 1st Degree",i:"🔥",bs:1},burn_2:{l:"Burn — 2nd Degree",i:"🔥",bs:2},burn_3:{l:"Burn — 3rd Degree",i:"🔥",bs:3},
  ...
  tooth_damage:{l:"Tooth Damage",i:"🦷",bs:0},crush_injury:{l:"Crush Injury",i:"🔨",bs:2},frostbite:{l:"Chilblains / Frostbite",i:"🥶",bs:0},
...
const WEAPONS = [
  ...
  {id:"bow",cat:"Bow & Arrow",guns:["Bow (any type)"],sevMod:-1,
    ...
    doHint:"arrow"},
  {id:"knife",cat:"Knife / Blade",guns:["Hunting Knife","Bowie Knife","Machete","Cleaver","Hatchet","Broken Bottle","Bayonet","Sword"],sevMod:0,
  ...
  {id:"hammer",cat:"Blunt / Crush Weapon",guns:["Hammer","Pickaxe","Rock/Stone","Rifle Butt","Boot (Stomping)","Falling Object"],sevMod:0,
    ...
    doHint:"blunt force impact"},
  {id:"horse",cat:"Horse & Animal",guns:["Horse Kick","Horse Trampling","Thrown from Horse","Wagon Crash","Wagon Wheel Run-Over","Bull/Steer Gore","Dog/Wolf Bite","Bear Attack","Cougar/Panther Attack","Alligator Attack"],sevMod:1,
...
var INT_DMG = [
  {id:"muscle",l:"Muscle Damage",sevMod:0,
    effects:{
      1:["Muscle bruised and sore — movement is stiff but functional","Tightness and aching, especially when using that muscle group"],
      2:["Muscle fibers partially torn — sharp pain with movement","Weakness in that area — can't exert full strength","Visible swelling and bruising over the muscle"],
      3:["Muscle torn significantly — movement is severely limited","The limb or area feels weak and unreliable","Atrophy is a risk if not used carefully during healing"],
      4:["Muscle shredded — barely functional","May need surgical repair to stitch the tissue back together","Long-term weakness or loss of range of motion possible"],
      5:["Muscle destroyed — that area won't work the same again","Permanent loss of strength or mobility without extensive treatment","Compensating with other muscles changes how you move"]
    }},
  {id:"nerve",l:"Nerve Damage",sevMod:1,
    effects:{
      1:["Tingling, pins-and-needles sensation in the area","Occasional numbness that comes and goes","Hypersensitivity — light touch feels sharp or burning"],
      2:["Persistent numbness — can't feel parts of the affected area","Shooting pain that radiates along the nerve path","Fine motor control reduced — fumbling, dropping things"],
      3:["Significant loss of sensation — can't feel temperature or pressure","Muscle weakness from the nerve not firing properly","Chronic burning or stabbing pain that doesn't match the visible wound"],
      4:["Major nerve severed or crushed — loss of function below the damage","Can't move or feel parts of the limb","Phantom sensations — pain in areas that are numb"],
      5:["Complete nerve destruction — the area is permanently without feeling or control","Paralysis of the affected region","The brain still sends signals but nothing responds"]
    }},
  {id:"vessel_nick",l:"Vessel Damage — Nicked",sevMod:1,
    effects:{
      1:["Slow, steady bleeding that won't fully stop on its own","Blood seeps rather than spurts — venous damage","Bruising spreads wider than expected from the wound"],
      2:["Persistent bleeding that requires pressure to control","Blood loss is gradual but adds up — dizziness after a while","The area swells as blood pools under the tissue"],
      3:["Nicked artery — blood pulses with the heartbeat","Bleeding is significant and hard to fully stop","Light-headedness, pale skin, cold extremities from blood loss"],
      4:["Arterial nick is leaking badly — blood loss is serious","Tourniquet or clamping needed to control it","Shock is setting in — confusion, rapid weak pulse, clammy skin"],
      5:["Major vessel damaged — life-threatening blood loss","Without immediate intervention, minutes matter","The body is shutting down — organs aren't getting enough blood"]
    }},
  {id:"vessel_sever",l:"Vessel Damage — Severed",sevMod:2,
    effects:{
      1:["Small vein severed — steady dark blood flow","Manageable with pressure but needs proper closure","Bruising and swelling around the site"],
      2:["Larger vein severed — blood flows freely, dark and steady","Needs clamping and stitching to stop","Blood loss accumulating — weakness setting in"],
      3:["Artery partially severed — bright red blood, pulsing","Serious blood loss happening fast","Tourniquet critical — every second counts"],
  ...
  {id:"organ",l:"Organ Involvement",sevMod:2,
    effects:{
      ...
      2:["Organ lacerated — internal bleeding has started","Sharp, deep pain that worsens with movement","Abdomen becoming rigid as blood pools inside"],
      3:["Organ punctured — contents may be leaking","Peritonitis risk — infection from organ contents in the body cavity","Fever, increasing pain, abdominal rigidity"],
      4:["Organ severely damaged — heavy internal bleeding","Surgical repair required — may need partial removal","Shock from blood loss, body shutting down non-essential functions"],
      5:["Organ destroyed or non-functional","Emergency surgery is the only option","Without intervention, organ failure cascades to other systems"]
    }},
];

var INT_SEV = [
  {v:1,l:"Mild",c:"#6b8f3c"},
  {v:2,l:"Moderate",c:"#b8860b"},
  {v:3,l:"Serious",c:"#cd6600"},
  {v:4,l:"Severe",c:"#b22222"},
  {v:5,l:"Critical",c:"#4a0000"},
];

// ═══════════════════════════════════════════════════════════════════════════════
// COMA / PROLONGED UNCONSCIOUSNESS — cause-specific guidance
// ═══════════════════════════════════════════════════════════════════════════════
var COMA_DATA = {
  head:{
    title:"Coma from Head Trauma",
    desc:"Brain swelling or bleeding inside the skull has shut down consciousness. The brain is protecting itself — or it's being crushed by pressure building inside a closed space.",
    signs:["Completely unresponsive — no reaction to voice, touch, or pain","Pupils may be unequal (one larger) or both fixed and dilated","Breathing may be irregular — long pauses, then gasping","May posture when stimulated: arms stiffen, wrists curl inward (bad sign)","Clear fluid from nose or ears = brain fluid leaking through a skull fracture","May have seizures — body stiffening and shaking"],
    doEx:["/do Lies motionless. Eyes closed, won't open. Pupils different sizes. Breathing comes in irregular gasps. No response to their name. No response to pain. Occasionally their body stiffens — arms pulling in, wrists curling. Brain fluid seeping from one ear.","/do Unconscious for hours now. Breathing on their own but it stutters and pauses. Face slack, no expression. Eyelids flutter sometimes but the eyes underneath are unfocused, rolling. A soft bump on the skull where the pressure is building."],
    recovery:["Days to weeks of unconsciousness is realistic for severe head trauma","When waking: confusion, amnesia, personality changes are all common","May not remember the event or days/weeks before it","Speech and motor skills may be impaired — slurred words, clumsy movements","Headaches, light sensitivity, mood swings for weeks after waking","Some patients wake up different — changed personality, emotional flatness, or volatility","A slow, frustrating return to normal is great RP material"]
  },
  gsw:{
    title:"Coma from Gunshot Wounds / Blood Loss",
    desc:"The body has lost so much blood that the brain isn't getting enough oxygen. It's shut down all non-essential functions to keep the heart and lungs going with what's left.",
    signs:["Unconscious, completely limp — no muscle tone at all","Skin is paper-white or grey, cold and clammy to touch","Pulse is barely detectable — rapid but threadlike","Breathing is shallow and fast — the lungs are working overtime with too little blood","Lips and fingernails are blue/grey (cyanotic)","If they survive: will be on IV fluids for days, too weak to move"],
    doEx:["/do White as a sheet. Cold to the touch. Pulse so faint you have to press hard to find it. Breathing fast and shallow. Blood soaked through the bandages. Lips turning blue. Completely gone from the world.","/do IV dripping into their arm. Bandages changed again — the bleeding has finally stopped but the damage is done. Face slack, grey. Hasn't moved in hours. Pulse still threading. Every breath is a fight their body is running on fumes."],
    recovery:["Unconsciousness from blood loss — hours to days depending on how much was lost","When waking: extreme weakness, can barely lift their head","Dizzy when sitting up — blood pressure is still low","Appetite massive — body craving iron and nutrients to rebuild blood","Cold easily — not enough blood to keep extremities warm","Exhaustion for days to weeks — even walking across a room is tiring","Emotional fragility — near-death experiences change people"]
  },
  crush:{
    title:"Coma from Crush Injury / Toxin Release",
    desc:"When crushed tissue is released, toxins from dead muscle flood the bloodstream and poison the kidneys, heart, and brain. The body has been overwhelmed by its own dying tissue.",
    signs:["Unconscious after the crush weight was removed — may have been alert before release","Urine is dark brown or absent — kidneys are failing from the toxins","Skin is mottled — patches of grey, purple, and normal color","Heart rhythm is irregular — the potassium from dead muscle affects the heart","May have seizures from electrolyte imbalance","The crushed area is massively swollen, hard, and discolored"],
    doEx:["/do Was talking when they pulled the beam off. Went quiet minutes later. Now nothing — unconscious, skin going blotchy. The crushed limb is swollen twice its size, hard as wood. Dark urine staining the sheet. Heart beating wrong — skipping, stuttering.","/do Hasn't woken since the rescue. The crushed area is enormous and purple-black. No urine output for hours. Skin mottled grey and purple everywhere. The toxins from the dead muscle are destroying them from the inside."],
    recovery:["If they survive the first 48 hours, the kidneys may recover","The crushed limb almost certainly needs amputation","Waking is slow and confused — brain was poisoned by muscle toxins","Kidney recovery takes weeks — patient is weak and nauseated throughout","May need ongoing IV fluids for days","The psychological impact of losing a limb after surviving a crush is enormous"]
  },
  multi:{
    title:"Coma from Multiple Injuries / Overwhelming Trauma",
    desc:"Too many injuries at once. The body can't cope with the combined blood loss, pain, and tissue damage. It's shut everything down to try to survive.",
    signs:["Unconscious — the body has entered a protective shutdown","Every vital sign is wrong: pulse too fast, breathing too shallow, blood pressure too low","Multiple wound sites still seeping despite bandaging","Skin is grey, cold, waxy — blood is being rationed to the brain and heart only","May be running a fever — the immune system is fighting on multiple fronts","Twitching or small movements don't mean consciousness — they're reflexes"],
    doEx:["/do A battlefield of bandages. Three separate wound sites, each one serious on its own. Together they've overwhelmed everything. Unconscious, grey, cold. Pulse racing but weak. The body has retreated into itself to survive.","/do Multiple injuries — each one treated but the total damage is more than any one wound. Hasn't opened their eyes in hours. Breathing automated, shallow. Face slack. The doc keeps checking vitals and saying nothing, which says everything."],
    recovery:["Recovery from multiple injuries is slow — the body is healing on several fronts at once","When waking: confusion about what happened, how long they've been out","Pain from multiple sites is overwhelming — pain management is critical","Each injury heals on its own timeline — one may improve while another worsens","Infection risk is multiplied with each wound site","The psychological weight of surviving this close to death shapes a person"]
  },
  poison:{
    title:"Coma from Poisoning / Overdose",
    desc:"The toxin or drug has depressed brain function to the point of unconsciousness. The brain is still there — it's just been chemically shut down.",
    signs:["Unconscious but may have some reflexes remaining","Pinpoint pupils (opioids) or dilated pupils (other toxins)","Breathing very slow and shallow (opioids) or irregular","May vomit while unconscious — EXTREME aspiration risk, keep on their side","Skin may be flushed, pale, or blue depending on the substance","Smell on breath may indicate the substance: alcohol, laudanum, ether"],
    doEx:["/do Collapsed. Laudanum bottle nearby, mostly empty. Pupils like pinpoints. Breathing so slow you have to watch carefully to see the chest move. Lips going blue. Pulse weak but there.","/do Found unconscious. No obvious wounds. Smells like alcohol and something sweet — laudanum. Vomit on the ground nearby. On their side now. Breathing four times a minute. Each breath a gamble."],
    recovery:["If the substance clears: may wake relatively quickly (hours)","Groggy, confused, nauseated when waking","If opioid: discuss addiction — this may have been intentional","If accidental: education about dosing","Liver and kidney damage possible from the overdose","Emotional state after waking: shame, relief, anger, denial — depends on circumstances"]
  }
};
var getComaType = function(injuries) {
  ...
  if(types.indexOf("poisoning")>=0||types.indexOf("overdose")>=0) return COMA_DATA.poison;
  // Multiple injuries
  if(injuries.length>=2) return COMA_DATA.multi;
  // GSW / blood loss
  if(types.some(function(t){return t.indexOf("gsw")>=0||t==="arterial_bleed"||t==="stab_wound";})) return COMA_DATA.gsw;
  // Default
  return COMA_DATA.multi;
};
...
var getLethalityWarning = function(zid, type, weaponId, sv) {
  ...
  var isBigGun = ["shotgun","sawnoff","rifle"].indexOf(wCat)>=0;

  // T&T through head = almost always fatal
  if(type==="gsw_tt"&&isHead) return {level:"fatal",msg:"A through-and-through gunshot to the head is almost always immediately fatal. This injury pattern leaves virtually no chance of survival."};
  // Shotgun/rifle to head = devastating
  if((type==="gsw_lodged"||type==="gsw_tt")&&isHead&&isBigGun) return {level:"fatal",msg:"A shotgun or rifle round to the head is catastrophic and almost certainly fatal. Survival from this injury pattern would be extraordinary."};
  // GSW lodged in head - possible but dire
  if(type==="gsw_lodged"&&isHead&&sv>=4) return {level:"dire",msg:"A bullet lodged in the skull is survivable in rare cases — but the odds are very poor. Brain damage, coma, or death are the most likely outcomes."};
  // Arterial bleed at throat
  if(type==="arterial_bleed"&&isThroat) return {level:"fatal",msg:"A severed carotid artery or jugular vein is fatal within minutes without immediate intervention. Even with treatment, survival is uncertain."};
  // Heart wounds
  if((type==="gsw_lodged"||type==="gsw_tt"||type==="stab_wound")&&isHeart&&sv>=3) return {level:"fatal",msg:"A penetrating wound to the heart is almost always fatal. The patient typically dies before reaching medical care."};
  // Throat stab/GSW
  if((type==="gsw_lodged"||type==="gsw_tt"||type==="stab_wound")&&isThroat&&sv>=3) return {level:"dire",msg:"Penetrating injuries to the throat damage the airway, major blood vessels, or both. Without immediate medical intervention, this is fatal."};
  // High severity head injuries
  if(isHead&&sv>=5) return {level:"dire",msg:"This injury to the head at this severity would most likely be fatal. Survival would require immediate, expert medical intervention — and even then, the outcome is uncertain."};
  // Skull pressure / drain at high sev
  if(type==="skull_pressure"&&sv>=4) return {level:"dire",msg:"Rising pressure inside the skull is compressing the brain. Without emergency surgery to relieve the pressure, this is fatal."};
  // Any injury at severity 5 in lethal zones
  if(sv>=5&&LETHAL_ZONES.indexOf(zid)>=0) return {level:"dire",msg:"This injury pattern at this severity in this location would very likely be fatal. Survival is possible but would require extraordinary medical intervention."};
  return null;
};
...
var getAvailIntDmg = function(zoneId) {
  var z = Z.find(function(zn){return zn.id===zoneId;});
  if(!z) return INT_DMG;
  var reg = z.reg;
  var id = z.id;
  // Organ damage ONLY available for torso regions
  var hasOrgan = (reg==="chest"||reg==="abdomen");
  // Vessel severed available for zones with major vessels
  var hasVesselSever = ["throat","l_neck","r_neck","heart","sternum","groin",
    "l_uthigh","r_uthigh","l_uarm","r_uarm","l_elbow","r_elbow",
    "ul_chest","ur_chest","ll_chest","lr_chest","solar","l_flank","r_flank","navel",
    "l_shoulder","r_shoulder","u_back","m_back"].indexOf(id)>=0;
  // Vessel nicked available almost everywhere with blood flow
  var hasVesselNick = ["l_eye","r_eye","l_ear","r_ear","nose"].indexOf(id)<0;
  // Muscle damage not available for eyes, ears, nose tip
...
function getCombined(injuries, zones) {
  ...
  // Injury types that count as REAL head trauma (brain/skull affecting)
  var REAL_HEAD_TRAUMA = ["concussion","skull_pressure","gsw_lodged","gsw_tt","gsw_graze","stab_wound","blast_shrapnel","crush_injury","strangulation","drowning"];
  ...
  injuries.forEach(function(inj) {
    ...
    var t = IT[inj.type];
    if (!t) return;
    var wm = getWeapon(inj.weapon);
    var sv = Math.min(5, Math.max(1, t.bs + (z.sev || 0) + (wm ? wm.sevMod || 0 : 0)));
    totalSev += sv;
    if (inj.type.indexOf("gsw") >= 0) gsws++;
    if (inj.type.indexOf("burn") >= 0) burns++;
    if (inj.type.indexOf("arterial") >= 0 || inj.type.indexOf("gsw") >= 0 || inj.type === "stab_wound") bleeds++;
    // Real head trauma: brain-affecting injury type AND in a brain zone, OR concussion/skull pressure anywhere relevant
    if (z.reg === "head" && REAL_HEAD_TRAUMA.indexOf(inj.type) >= 0 && (BRAIN_ZONES.indexOf(z.id) >= 0 || inj.type === "concussion" || inj.type === "skull_pressure" || inj.type === "drowning")) headInj = true;
    if (z.reg === "chest" && REAL_CHEST_IMPAIR.indexOf(inj.type) >= 0) chestInj = true;
    if (z.reg === "leftArm") hasLArm = true;
    if (z.reg === "rightArm") hasRArm = true;
    if (z.reg === "leftLeg") hasLLeg = true;
    if (z.reg === "rightLeg") hasRLeg = true;
    if (sv >= 3) needsMorphine++;
  });

  // Blood loss compound
  if (bleeds >= 2) {
    parts.push("Multiple bleeding wounds at once — blood loss compounds fast. Shock sets in sooner than any single wound would cause. Pale, clammy, confused, fading.");
  }

  // Both arms
  if (hasLArm && hasRArm) {
    parts.push("Both arms injured — can't hold a weapon properly in either hand. Loading, aiming, and firing anything is a struggle. Even holding reins requires gritting through pain on both sides.");
  }

  // Both legs
  if (hasLLeg && hasRLeg) {
    parts.push("Both legs hit — walking is barely possible, running isn't. Mounting a horse requires being lifted. Every step is a decision about which leg hurts less.");
  }

  // Arm + leg same side
  if ((hasLArm && hasLLeg) || (hasRArm && hasRLeg)) {
    var side = (hasLArm && hasLLeg) ? "left" : "right";
    parts.push("The entire " + side + " side is compromised. Moving, fighting, riding — everything favors the good side. The body instinctively guards the injured side, making you predictable.");
  }

  // Chest + leg
  if (chestInj && (hasLLeg || hasRLeg)) {
    parts.push("Chest wound plus leg injury is a brutal combination — can't breathe deeply AND can't move well. Any physical exertion is limited by whichever is worse. Getting to safety is slow and agonizing.");
  }

  // Head + anything
  if (headInj && injuries.length >= 2) {
    parts.push("Head injury on top of body trauma — the confusion and dizziness from the head wound makes dealing with everything else harder. May forget instructions, lose focus during treatment, or pass out unexpectedly.");
  }

  // Multiple GSWs
  if (gsws >= 2) {
    parts.push("Multiple gunshot wounds mean a longer, more complex treatment. Each bullet track needs to be explored, cleaned, and closed separately. Time on the table is significantly longer.");
  }

  // Multiple burns
  if (burns >= 2) {
    parts.push("Multiple burn sites — the body is losing fluid from every burned area simultaneously. Dehydration and infection risk multiply with each additional burn. Bandage changes take much longer.");
  }

  // Drug concerns
  if (needsMorphine >= 2) {
    parts.push("Multiple severe injuries means prolonged pain management — morphine or laudanum will be needed for an extended period. The addiction risk is real and worth exploring in RP. Withdrawal symptoms, craving, dependence — these are rich character arcs if you want to go there.");
  }

  // High total severity
  if (totalSev >= 8) {
    parts.push("The combined damage is severe enough that survival itself is a story beat. Recovery isn't measured in hours but in days and weeks of RP. Follow-up visits, setbacks, complications, slow improvement — each one is a scene.");
  }

  // Infection compound
  if (injuries.length >= 3) {
    parts.push("Three separate wounds means three separate infection risks. If even one gets dirty, the whole body is fighting on multiple fronts. Fever, chills, and declining health could spiral if aftercare is neglected.");
  }
...
// OUTPUT DATA
// ═══════════════════════════════════════════════════════════════════════════════
const gfs=(o,s)=>{if(o[s])return o[s];for(let d=1;d<=5;d++){if(o[s-d])return o[s-d];}for(let d=1;d<=5;d++){if(o[s+d])return o[s+d];}return Object.values(o)[0]||[];};
...
const OD = {
  open_wound:{sym:{1:["Shallow cut, bleeding, stings"],2:["Deep laceration, steady bleeding, possible muscle visible"],3:["Gaping wound, heavy blood flow, pale skin"],4:["Devastating wound, blood pooling, barely conscious"]},
    ...
    doEx:{1:["/do A shallow gash across their {z}, bleeding lightly. Capillary bleed — seeping, not flowing."],2:["/do Deep laceration on their {z}. Dark blood oozing steadily — venous. Edges ragged."],3:["/do Gaping wound on their {z}. Blood flowing freely. Pale and clammy. Pulse rapid."],4:["/do Massive open wound on their {z}. Tissue torn wide. Bright and dark blood mixing. Muscle visible in the depths. Going into shock."],5:["/do Their {z} is laid open to the bone. Blood everywhere — arterial and venous flowing together. Skin white. Eyes rolling. Body shutting down."]},rec:["Keep bandages clean — change daily","Watch for infection: redness, pus, dark tissue","Return for suture removal if stitched"],drugs:["Cocaine paste might numb for sutures","If stronger meds used, in-game addiction may kick in"]},
  gsw_graze:{sym:{1:["Bullet skimmed the surface — long shallow furrow, lots of blood but no penetration","Burns along the graze from bullet heat"],2:["Deep graze carving a channel through skin and muscle","Heavy bleeding, raw and exposed","Possible bone chip if over bone"],3:["Graze carved down to bone — skull, rib, or shin exposed in the furrow","Heavy bleeding, tissue peeled back along the channel"],4:["Graze caught something vital underneath — artery nicked, nerve exposed","Bleeding won't stop, numbness spreading beyond the wound"],5:["Devastating graze across a critical area — bone chipped, vessel torn, tissue destroyed along the entire channel","Shock setting in from blood loss despite it 'only being a graze'"]},
    ...
    doEx:{1:["/do A long furrow across their {z} where the bullet skimmed. Bleeding and raw, but didn't go in."],2:["/do Deep graze carving a channel through {z}. Muscle visible in the furrow. Bleeding heavy."],3:["/do Bullet carved a deep furrow across {z}, scraping bone underneath. Tissue peeled back. Blood flowing freely."],4:["/do Graze tore deep across {z} — nicked something underneath. Blood pulsing from the furrow. Numbness spreading. Going pale."],5:["/do Devastating graze across {z}. Bone exposed in the channel. Vessel torn open underneath. Blood pouring. Shock setting in despite no bullet inside."]},
    wDoEx:{handgun:{1:["/do Revolver round skimmed across {z}, leaving a shallow burn-like furrow. Bleeding but intact."],2:["/do Pistol round carved a deep channel across {z}. Muscle exposed in the furrow. Powder burns blackening the edges."],3:["/do Revolver round dug deep across {z}. Bone glimpsed in the furrow. Blood flowing steady and dark."],4:["/do Pistol graze caught an artery under {z}. Blood pulsing from what should be a minor wound. Going pale fast."],5:["/do Revolver round carved {z} down to bone across its full length. Vessel torn. Blood everywhere. Shock from 'just a graze.'"]},sawnoff:{1:["/do Shotgun pellets peppered across {z}. Dozens of tiny holes, bleeding from each. Skin stippled and raw."],2:["/do Sawed-off blast raked across {z}. Shallow but wide — pellets scattered across the surface, each one bleeding."],3:["/do Sawed-off caught the edge of {z}. Pellets dug in deep across a wide swath. Some hit bone. Bleeding from dozens of points."],4:["/do Sawed-off blast raked across {z} — pellets embedded in bone, vessels nicked. Bleeding from everywhere. Can't stop them all."],5:["/do Sawed-off blast peeled {z} open across a wide area. Tissue shredded. Bone pockmarked with embedded shot. Massive blood loss from dozens of channels."]},repeater:{1:["/do Repeater round grazed {z}, tearing a deeper furrow than a pistol would leave. Raw, bleeding steadily."],2:["/do Repeater round carved a deep channel through {z}. Higher velocity means the graze goes deeper than it looks."],3:["/do Repeater graze carved down to bone at {z}. Higher velocity made the furrow deeper and wider than a pistol graze. Blood flowing."],4:["/do Repeater round skimmed {z} but the velocity carried it deep. Bone exposed. Something underneath is bleeding badly. Going grey."],5:["/do Repeater graze devastated {z}. The velocity carved a trench through tissue and bone. Vessel torn. Bleeding like a lodged round despite passing over."]},shotgun:{1:["/do Shotgun pellets grazed {z}. Scattered pattern of shallow wounds across the area, each one stinging and bleeding."],2:["/do Shotgun blast caught the edge of {z}. Wide swath of pellet marks — some shallow, some dug in. Bleeding from a dozen points."],3:["/do Shotgun blast raked across {z}. Pellets embedded across a wide area, some deep enough to hit bone. Bleeding from everywhere."],4:["/do Shotgun pellets dug deep across {z}. Bone chipped. Vessels nicked by multiple pellets. Blood seeping from too many points to pressure."],5:["/do Full shotgun blast raked across {z}. Tissue shredded across the entire area. Bone pocked and cracked. Blood loss catastrophic from dozens of channels."]},rifle:{1:["/do High-caliber round grazed {z}. Even the graze carved a deep furrow — the energy bruised tissue around the channel."],2:["/do Rifle round skimmed {z}, tearing a wide, deep channel. Surrounding tissue is bruised from the shockwave alone."],3:["/do Rifle graze carved {z} open to bone. The energy bruised everything for inches around the channel even without penetrating."],4:["/do High-caliber graze across {z}. The shockwave alone damaged tissue beyond the furrow. Bone cracked underneath. Vessel torn by energy transfer."],5:["/do Rifle round grazed {z} and the energy transfer alone nearly killed. Bone shattered under the furrow. Tissue destroyed for inches around. Bleeding like a direct hit."]}},
    rec:["Treat like a bad open wound — clean, disinfect, bandage","Watch for embedded debris or fabric","Powder burns if close range — stinging, blackened skin","Less severe than lodged bullet but needs proper care"],drugs:["Cocaine paste for numbing during cleaning","Aspirin usually enough unless deep"]},
  gsw_lodged:{sym:{1:["Small caliber, lodged shallow"],2:["Significant bleeding, numbness spreading"],3:["Bullet deep, internal damage likely, cold sweats"],4:["Possible fragmentation, fading in and out"]},
    ...
    doEx:{1:["/do Small entry wound on their {z}. No exit. Bleeding controlled."],2:["/do Entry wound on {z}, no exit. Swelling fast. Numbness spreading below."],3:["/do Bullet wound on {z}. Blood pooling. Ashen. Pulse thready and rapid."],4:["/do Bullet buried deep in {z}. Entry wound swollen shut. Blood seeping from underneath. Skin grey, cold. Drifting in and out of consciousness."],5:["/do Devastating gunshot to {z}. Entry wound ragged. Blood everywhere. No response to voice. Pulse barely there. Body shutting down."]},
    wDoEx:{handgun:{1:["/do Small round entry on their {z}, about pencil-sized. Bleeding steady but controlled. Bullet somewhere inside."],2:["/do Revolver round lodged in {z}. Entry wound neat and round. Swelling fast around it. Numbness creeping outward."],3:["/do Pistol round buried deep in {z}. Blood pooling underneath. Skin going grey. Pulse weak and racing."],4:["/do Revolver round lodged deep in {z}. Entry swollen, blood weeping from it. Face ashen, lips pale. Barely responding. Bullet may have fragmented inside."],5:["/do Pistol round tore into {z} and stayed. Blood soaking through everything. Eyes rolling back. Pulse thready and fading. Body going cold from the extremities inward."]},sawnoff:{1:["/do Shotgun pellets peppered into {z}. Shallow but scattered. Dozens of small entry points bleeding."],2:["/do Sawed-off blast tore into their {z} at close range. Dozens of pellets embedded in shredded flesh. Bleeding from everywhere."],3:["/do Point-blank sawed-off hit to {z}. One massive ragged crater of torn muscle and embedded shot. Barely conscious."],4:["/do Sawed-off blast at close range destroyed their {z}. Pellets buried in pulped tissue. Bone fragments mixed with shot. Unconscious, blood loss catastrophic."],5:["/do Sawed-off blast obliterated their {z}. A crater of shredded flesh and embedded shot. No recognizable tissue structure. Bleeding from everywhere. Dying."]},repeater:{1:["/do Clean entry on {z} from a repeater round. Deeper channel than a pistol would leave. Bleeding moderate."],2:["/do Repeater round lodged in {z}. Entry wound slightly larger than a handgun's. Tissue damaged deeper along the path."],3:["/do Repeater round buried in {z}. Higher velocity means more damage than it looks. Blood flowing freely. Going pale."],4:["/do Repeater round punched deep into {z}. The higher velocity tore through tissue along the entire path. Blood flowing steady and dark. Consciousness fading."],5:["/do Repeater round buried to the bone in {z}. Entry wound weeping. Internal damage catastrophic — the velocity shredded everything in its path. Unresponsive."]},shotgun:{1:["/do Shotgun pellets clustered tight in {z}. Shallow but many. Bleeding from a dozen small wounds."],2:["/do Shotgun blast cratered their {z}. Dozens of pellet wounds clustered tight. Tissue pulped. Bleeding from every hole."],3:["/do Full shotgun hit to {z}. Pellet mass went in as one devastating blow. Wound cavity the size of a fist. Bone fragments visible. Fading fast."],4:["/do Shotgun blast at close range tore {z} apart. Pellets embedded inches deep across the area. Tissue destroyed. Bone shattered. Bleeding from dozens of channels at once. Going into shock."],5:["/do Point-blank shotgun hit destroyed {z}. The pellet mass created one massive wound cavity. Organs visible. Bone pulverized. Blood loss is catastrophic. Minutes left without intervention."]},rifle:{1:["/do Rifle round lodged in {z}. Entry larger than a handgun's. Deeper damage than the hole suggests. Bleeding steady."],2:["/do Large-caliber rifle round lodged in {z}. Entry wound notably bigger than a pistol's. Surrounding tissue bruised from energy transfer alone."],3:["/do High-caliber round buried in {z}. Entry wound is the size of a thumb. The energy shockwave has damaged tissue well beyond the bullet path. Ashen, barely responsive."],4:["/do Rifle round lodged deep in {z}. The entry is ragged and wide. Energy transfer has bruised and torn tissue inches beyond the bullet path. Unconscious. Blood pressure plummeting."],5:["/do High-caliber round embedded in {z}. Massive entry wound. The shockwave alone has destroyed tissue in a cone around the path. Internal devastation. Pulse is barely detectable. This is fatal without immediate surgery."]}},
    rec:["Expect bed rest","Multiple follow-ups","Bullet path may have caused internal damage"],drugs:["Morphine likely — addictive in-game","Ether if surgery — groggy after","In-game addiction tracks opioid use"]},
  gsw_tt:{sym:{1:["Clean pass, entry small, exit bigger"],2:["Entry clean, exit messy, internal damage along path"],3:["Massive exit wound, shock"],4:["Exit devastating, barely responsive"]},
    ...
    doEx:{1:["/do Small entry on front of {z}, larger exit wound back. Bleeding both sides."],2:["/do Entry clean. Exit torn open on {z}. Bright and dark blood mixing."],3:["/do Through-and-through on {z}. Exit devastating. Ashen, pulse barely there."],4:["/do Bullet punched clean through {z}. Entry neat but exit is a ragged hole of torn flesh. Blood pouring from both sides. Unconscious, barely breathing."],5:["/do Through-and-through destroyed {z}. Entry wound. Exit wound is catastrophic — tissue blown outward. Blood everywhere. No response. Pulse fading to nothing."]},
    wDoEx:{handgun:{1:["/do Neat round entry on their {z}. Exit wound on the other side slightly larger, ragged. Bleeding from both."],2:["/do Revolver round punched clean through {z}. Entry pencil-sized. Exit torn open and weeping dark blood."],3:["/do Pistol round through {z}. Exit blown out, flesh peeled back. Blood mixing bright and dark. Going limp."],4:["/do Revolver round passed through {z}. Entry small but exit is torn wide. Blood flowing freely from both. Face grey. Consciousness gone."],5:["/do Pistol round tore through {z} and out the other side. Both wounds bleeding heavy. Body limp, cold. No response to anything."]},sawnoff:{1:["/do Sawed-off pellets punched through {z}. Entry peppered. Exit side has scattered pellet holes. Bleeding from multiple points."],2:["/do Sawed-off blast ripped through {z}. Entry is a mess of pellet holes. Exit side is shredded — pellets tore through everything."],3:["/do Close-range sawed-off tore clean through {z}. Exit wound the size of two fists. Tissue, bone, blood everywhere."],4:["/do Sawed-off at close range blew through {z}. Entry side is cratered. Exit side is destroyed — tissue hanging in ribbons. Blood loss is overwhelming."],5:["/do Sawed-off blast punched through {z} completely. Both sides are devastated. Organs visible through the exit. This is not survivable without a miracle."]},repeater:{1:["/do Repeater round passed through {z}. Entry clean, exit a bit ragged. Bleeding both sides but controlled."],2:["/do Repeater through {z}. Entry neat, exit torn wider. Deeper channel than a pistol — more damage along the path."],3:["/do Repeater round tore through {z}. Exit wound blown open. Everything between entry and exit is damaged. Fading."],4:["/do Repeater round punched clean through {z}. Higher velocity carved a wide path of destruction. Exit wound gaping. Losing blood fast from both sides."],5:["/do Repeater round obliterated its path through {z}. Entry and exit both gaping. Internal destruction total along the bullet's channel. Unresponsive. Bleeding out from both sides."]},shotgun:{1:["/do Shotgun pellets passed through {z}. Scattered entry wounds. Exit side has fewer, larger holes where pellets grouped going out."],2:["/do Shotgun pellets ripped through {z}. Entry a cluster of holes. Exit side is devastated — pellets scattered through tissue on the way out."],3:["/do Full shotgun blast clean through {z}. Entry is a cratered mass. Exit is catastrophic — tissue blown outward. Organs visible."],4:["/do Shotgun blast tore through {z}. Dozens of pellet tracks through the tissue. Exit side looks like it exploded outward. Bone, tissue, blood. Dying."],5:["/do Shotgun blast obliterated {z} front to back. Nothing left intact between entry and exit. Catastrophic. Fatal without immediate intervention."]},rifle:{1:["/do Rifle round passed clean through {z}. Entry large. Exit notably bigger. Deep channel but controlled bleeding."],2:["/do High-caliber round punched through {z}. Entry notably large. Exit wound is blown wide open — fist-sized hole of torn flesh."],3:["/do Rifle round through {z}. The energy blew the exit wound open like a flower. Tissue destroyed for inches around the path. Barely alive."],4:["/do Rifle round tore through {z}. Entry is thumb-sized. Exit is fist-sized and ragged. The shockwave damaged everything between and beyond. Unconscious, bleeding out."],5:["/do High-caliber round through {z}. Exit wound is catastrophic — tissue and bone blown outward in a cone. The energy transfer destroyed everything. No pulse detectable."]}},
    rec:["Extended bed rest","Daily bandage changes both wounds","Infection biggest secondary risk"],drugs:["Morphine or laudanum — addictive","Cocaine might maintain heart rate via IV","Opioid use adds 24h drug recovery"]},
  stab_wound:{sym:{1:["Shallow puncture, sharp pain"],2:["Deep puncture, steady bleeding"],3:["Deep stab, internal damage, heavy bleeding"]},
    ...
    doEx:{1:["/do Puncture wound on {z}, couple inches deep."],2:["/do Deep stab in {z}. Blood wells up."],3:["/do Deep stab in {z}. Blood dark, flowing. Abdomen rigid. Skin cold."],4:["/do Stab wound driven deep into {z}. Blood flowing dark and steady. Abdomen board-hard. Skin clammy and grey. Eyes glazing over."],5:["/do Devastating stab wound to {z}. Blood pouring out. No color left in the face. Body going limp. Pulse barely detectable."]},
    wDoEx:{knife:{1:["/do Clean narrow slit on their {z}. Blood welling up from the cut. Edges neat — a sharp blade."],2:["/do Knife buried deep in {z}. Blood seeping around the handle. The blade went in smooth and far."],3:["/do Blade driven to the hilt in {z}. Dark blood flowing around it. Skin going cold. The knife is plugging its own wound."],4:["/do Blade buried to the handle in {z}. Blood soaking through clothing around it. Face white, breathing shallow. The knife is the only thing keeping the blood inside."],5:["/do Multiple knife wounds to {z}. Each one bleeding freely. Blood everywhere. No resistance left. Body crumpling."]},bow:{1:["/do Arrow shaft protruding from {z}. Blood seeping around where it entered. Shaft wobbles with each breath."],2:["/do Arrow embedded deep in {z}. Broadhead cut a slit going in. Blood flows around the shaft. Moving the arrow shifts something inside."],3:["/do Arrow punched clean into {z}. Shaft buried to the fletching. Blood pooling. Every movement drives the broadhead deeper."],4:["/do Arrow buried deep in {z}, only the fletching visible. Blood flowing around the shaft in pulses. The broadhead has hit something vital inside. Fading."],5:["/do Arrow driven through {z} with devastating force. Shaft snapped from impact. Blood pouring from around the embedded head. No response. Dying."]}},
    rec:["Keep wound covered and clean","Infection risk high — stabbing instruments rarely clean","Limit movement of affected area"],drugs:["Morphine for severe, cocaine paste for sutures","A blade left in is acting as a plug for the wound"]},
  burn_1:{sym:{1:["Patch of red tender skin like a mild sunburn"],2:["Bright red, slightly swollen, stings to touch"],3:["Larger area, hot to touch, throbbing, edges starting to blister"],4:["Extensive red burned area, swollen, weeping in spots, bordering on second degree"],5:["Massive area burned, parts blistering, dehydration risk from the sheer extent"]},signs:["🔥 Skin: Red, dry, intact — no blisters","👆 Touch: Painful, flinches from contact","📏 Area: Note how large — palm-sized or larger is noteworthy"],doEx:{1:["/do Skin on {z} bright red and tender. Intact but painful to touch."],2:["/do Angry red burn across {z}. Swollen, hot to touch. Flinches from contact. Skin tight and stinging."],3:["/do Burn across {z} deep enough to weep. Skin blistering at the edges — bordering on second degree. Swollen and throbbing."],4:["/do Extensive first-degree burn covering most of {z}. Skin angry red, swollen, weeping in spots. Pain is constant and intense."],5:["/do Massive area of {z} burned. Red, swollen, some areas blistering — crossing into second degree territory. Shaking from pain. Dehydration risk from the extent."]},rec:["Bandage change once daily","Heals in days, some peeling"],drugs:["Aspirin usually enough","Aloe gel for the burn"]},
  burn_2:{sym:{1:["Small blisters forming, raw pink skin where they pop"],2:["Multiple intact blisters, very painful to touch, weeping clear fluid"],3:["Blisters bursting, raw exposed dermis, agonizing, fluid loss starting"],4:["Extensive raw tissue exposed, blisters mostly burst, can't bear contact, dehydration"],5:["Large area of raw exposed dermis, fluid loss critical, edging into third degree in spots"]},signs:["🔥 Skin: Blistered — some intact, some burst, weeping clear fluid","👆 Touch: EXTREMELY painful — nerves intact, more painful than 3rd degree","💧 Fluid: Clear = normal; cloudy/yellow = infection developing","📏 Area: Larger burns = more fluid loss = dehydration risk"],doEx:{1:["/do Blistered skin on {z}. Some burst, weeping clear fluid. Screams at contact."],2:["/do Extensive second-degree burns on {z}. Raw, weeping, agonizing."],3:["/do Deep second-degree burns across {z}. Blisters burst, raw tissue exposed. Fluid weeping constantly. Can't bear anything touching it."],4:["/do Severe burns covering {z}. Skin destroyed, raw tissue underneath weeping. Some areas crossing into third degree — white patches amid the red. Screaming or gone silent from the pain."],5:["/do Devastating burns across {z}. Most blisters burst, tissue raw and exposed. Fluid loss critical — skin can't hold moisture. Edging into third degree in the worst patches. Shock from pain and fluid loss."]},rec:["Bandage change TWICE daily","Scarring possible","Infection on burned skin dangerous"],drugs:["Laudanum or morphine may be needed","In-game addiction system applies"]},
  burn_3:{sym:{1:["Small white/waxy patch, no pain at center (nerves dead), edges hurt"],2:["Charred/waxy skin, center numb, edges burning intensely"],3:["Larger area destroyed, skin blackened and leathery, tissue visible at edges"],4:["Most of area destroyed, skin cracked like dried leather, fluid loss severe"],5:["Devastating burn — charred to bone in places, body losing fluid faster than it can be replaced"]},signs:["🔥 Skin: Charred, white/waxy, leathery — destroyed","👆 Touch: CENTER has no pain (nerves dead), EDGES agonizing","⚠️ Key: No pain at center + edge pain = 3rd degree","🖤 Necrosis: Dead tissue needs removal (maggots or cutting)","💧 No blisters: Skin too destroyed to blister, unlike 2nd degree"],doEx:{1:["/do Small patch on {z} where the skin has gone white and waxy. No pain at that spot — nerves are dead. Edges hurt intensely."],2:["/do Charred skin on {z}. Blackened patches. No feeling center — screams at edges."],3:["/do Extensive third-degree burns on {z}. Skin charred and leathery. Dead center, agonizing edges. The smell of burned flesh in the air."],4:["/do Most of {z} destroyed. Skin blackened, cracked like dried leather. Tissue visible underneath. No pain in the burned area but the edges are unbearable. Fluid loss is severe. Shock setting in."],5:["/do {z} is devastated — charred black, tissue destroyed down to bone in places. The body is losing fluid faster than it can be replaced. Infection will follow. This is life-altering if they survive."]},rec:["Bandage change THREE times daily","Permanent scarring almost certain","Maggots may remove dead tissue","Defining character trait"],drugs:["Strong pain meds — prolonged exposure","Addiction mechanic very relevant"]},
  concussion:{sym:{1:["Slight headache, dizzy, seeing stars"],2:["Confusion, nausea, balance problems, light sensitivity"],3:["Severe disorientation, vomiting, may black out"]},
    ...
    doEx:{1:["/do Eyes unfocused. Dazed but knows name and location."],2:["/do Pupils uneven. Stumbles. Asks same question twice. Light hurts."],3:["/do Barely conscious. Vomiting. Pupils dilated. Slurred speech."],4:["/do Unresponsive to voice. Pupils fixed and dilated. Breathing irregular. Posturing when touched — arms stiffening."],5:["/do No response to anything. Pupils blown. Breathing stopping and starting. Clear fluid leaking from nose or ear. Brain is swelling."]},rec:["Minor: take it easy","Moderate/Severe: watch them — avoid sleeping","Memory gaps, irritability, fog are natural to play"],drugs:["Aspirin for headache","Docs avoid opioids — masks brain symptoms"]},
  broken_nose:{sym:{1:["Slightly crooked, mild swelling, blood from one or both nostrils"],2:["Visibly bent sideways, heavy swelling, blocked breathing, mouth-breathing"]
,3:["Severely displaced, cartilage crushed, both nostrils blocked, heavy bleeding"],4:["Nose flattened, bone fragments palpable, choking on blood draining into the throat"],5:["Face caved in around the nose — cheekbones and orbital floor likely fractured too, airway compromised"]},signs:["👃 Alignment: Visibly crooked or shifted","🩸 Bleeding: Heavy from both nostrils","😤 Breathing: Blocked, mouth-breathing","👁️ Raccoon eyes: Bruising under eyes may develop","🦴 Crepitus (bone grinding): Grinding feel when touched = fragments"],doEx:{1:["/do Nose crooked, swelling. Blood from nostrils. Already bruising under eyes."],2:["/do Nose badly displaced — bent sideways. Heavy swelling closing both nostrils. Mouth-breathing. Blood streaming. Raccoon eyes developing."],3:["/do Nose shattered. Cartilage and bone crushed flat. Blood pouring. Can't breathe through it at all. Face swelling fast. Fragments grinding when touched."],4:["/do Nose destroyed — flattened against the face. Bone fragments palpable. Blood flowing into the throat — choking, gagging. Eyes swelling shut from the facial trauma."],5:["/do Face caved in around the nose. Bones of the face fractured — not just the nose but the cheekbones, orbital floor. Blood everywhere. Airway compromised from the swelling and blood. Barely conscious from the pain."]},rec:["Don't touch it","Swelling for days","Flinch if someone gets near your face"],drugs:["Cocaine paste before reset","Leather to bite during"]},
  skull_pressure:{sym:{3:["Intense headache, soft bump, fluid from nose/ears"],4:["Life-threatening pressure, unconscious"]},
    ...
    doEx:{1:["/do Headache building behind the eyes. Temples feel tight. Squinting at light. Something isn't right."],2:["/do Pressure building in the skull. Temples throbbing, vision blurring. Nausea. A soft spot developing above the ear."],3:["/do Soft spongy bump on skull. Clear fluid from ear — brain fluid (CSF) leaking. Pupils uneven. Confused."],4:["/do Unconscious. Soft depression on skull. Fluid from nose and ears. Pupils fixed/dilated. Pulse slowing."],5:["/do Skull pressure critical. Brain herniation — body posturing, arms stiffening, back arching. Pupils blown. Breathing stopping. Without emergency surgery, death is minutes away."]},rec:["Extended bed rest — pressure change affects balance","Dizziness, light/sound sensitivity for days"],drugs:["Ether for procedure, morphine after — both addictive","24h drug recovery"]},
  deflated_lung:{sym:{3:["Shortness of breath, one-sided chest pain, gurgling"],4:["Extreme difficulty breathing, blue lips, gasping"]},
    ...
    doEx:{1:["/do Catches their breath sharply. Pain on one side when inhaling deep. Breathing a little faster than normal. Something feels wrong in the chest."],2:["/do Wincing with every breath. One side of the chest not moving right. Getting short of breath. Slight wheeze audible."],3:["/do Struggling to breathe. One side barely moves. Gurgling. Speaking in broken gasps."],4:["/do Gasping. Lips blue. Gurgling. One side sunken. Trachea shifting."],5:["/do No air moving. Chest silent on one side. Lips grey-blue, fingertips dark. Trachea pushed hard to the other side — tension building. Heart being compressed. Minutes from cardiac arrest."]},rec:["Bed rest","No running, shouting, heavy lifting","Shortness of breath for days"],drugs:["Ether and morphine — both addictive, 24h recovery"]},
  rib_fracture:{sym:{1:["Hurts to breathe deep, cough, laugh"],2:["Sharp pain every breath, heavy bruising"],3:["Multiple breaks, rapid shallow breathing, maybe blood"]},
    ...
    doEx:{1:["/do Winces breathing deep. Bruising. Sharp pain at one specific spot."],2:["/do Shallow breaths. Purple bruising. Grinding when touched. Guards the area."],3:["/do Multiple breaks. Rapid shallow breathing. Coughing blood. Chest section moves wrong."],4:["/do Flail chest — a section of ribs moving opposite to breathing. Coughing pink froth. Can barely get air. Face going blue."],5:["/do Chest caved in. Ribs shattered in multiple places. Breathing almost stopped. Lung punctured — gurgling with each weak gasp. Cyanotic."]},rec:["No heavy lifting, running, fighting","Deep breaths hurt for days","Compression bandage stays on"],drugs:["Laudanum or morphine beyond hairline"]},
  organ_damage:{sym:{3:["Deep internal pain, rigid abdomen, nausea"],4:["Abdomen swollen, internal bleeding, fading"]},
    ...
    doEx:{1:["/do Deep ache inside, worse with movement. Belly tender when pressed. Something bruised underneath."],2:["/do Sharp internal pain. Abdomen starting to tighten. Nauseous. Pressing on the belly makes them cry out."],3:["/do Abdomen rigid. Bruising appearing on belly despite no external wound. Nauseous."],4:["/do Abdomen swollen, hard. Pulse rapid but weak. Getting worse."],5:["/do Abdomen distended and tight as a drum. Skin mottled grey and purple. No response to pain. Pulse barely palpable. Organs failing."]},rec:["48-72h minimum bed rest","Soft food diet","Multiple follow-ups"],drugs:["Ether for surgery, morphine after — both addictive"]},
  fracture_hairline:{sym:{1:["Aching, swelling, bruising — can move but hurts"],2:["Significant swelling, sharp pain with movement"]},signs:["🦴 Point tenderness: One specific painful spot","💜 Swelling: Localized over bone","🏃 Activity: Gets worse with use","👆 Vibration: Tapping nearby sends jolt through bone"],doEx:{1:["/do Swelling and bruising on {z}. Can move but grimaces. One spot sharply tender."],2:["/do Significant swelling on {z}. Sharp pain with any movement. Can still use it but every motion makes them wince. Clearly favoring it."],3:["/do {z} swollen and hot. Hairline crack is worsening with use — pain increasing. Can barely put weight on it or use it. Needs immobilization now."],4:["/do Hairline fracture on {z} has spread from continued stress. Swelling massive. Any movement sends shooting pain. The bone is about to give way completely."],5:["/do What started as a hairline crack on {z} has become a full fracture from continued use. Bone shifted. Swelling enormous. Can't use it at all. Should have stopped earlier — now it's a real break."]},rec:["Keep splint/cast on","No heavy use","Tender for a while"],drugs:["Aspirin or phenacetin","Medicinal mota for pain/sleep"]},
  fracture_linear:{sym:{2:["Clear break, intense pain, can't use limb"],3:["Bone visibly displaced, wrong angle"],4:["Bone through skin, shock"]},
    ...
    doEx:{1:["/do Their {z} swollen and painful. Can barely move it. Something shifted inside — a grinding feeling when they try."],2:["/do Their {z} bent wrong. Massive swelling. Grinding when moved. Can't feel below it."],3:["/do Bone displaced under skin. Limb shortened. No pulse below."],4:["/do Bone protruding through the skin. White bone visible through torn flesh. Blood flowing from the open fracture. Limb at a sickening angle."],5:["/do Compound fracture — bone jutting out through mangled skin. Limb bent completely wrong. Blood everywhere. Shock. Screaming or silent."]},rec:["Splint stays on","No use of limb extended period","Limp, sling — natural to play out","Follow-ups for plates"],drugs:["Morphine almost certainly","Ether if surgery","24h drug recovery"]},
  fracture_comminuted:{sym:{4:["Bone shattered — limb unsalvageable"],5:["Catastrophic limb destruction, shock"]},signs:["🦴 Destruction: Bone in multiple pieces — structurally gone","🩸 Bleeding: Massive — fragments shred vessels from inside","😰 Shock: Immediate — pale, cold, rapid thready pulse","⚡ No sensation: Complete loss below injury","💀 Tissue death: Color changing, limb going cold — blood supply destroyed"],doEx:{1:["/do Bone at {z} cracked in several places. Grinding inside. Can't use it but the pieces haven't separated yet. Still has feeling below."],2:["/do Bone at {z} in multiple pieces. Fragments shifting under the skin. Swelling massive. Limited feeling below — blood supply compromised."],3:["/do Bone at {z} shattered. Fragments visible under taut, bruised skin. No feeling below the break. Limb going cold. The structural integrity is gone."],4:["/do Their {z} destroyed. Bone fragments through flesh. No feeling below. Limb cold. Shock."],5:["/do Their {z} is obliterated — bone in a hundred pieces, each one shredding vessels and muscle from the inside. Limb is dead weight. Grey, cold, gone. Shock is killing them."]},rec:["Losing a limb — permanent","Extended recovery, daily bandages","Phantom pain to explore","Character-defining moment"],drugs:["Ether — must be unconscious","Morphine post-op — highly addictive","Prolonged exposure — addiction mechanic kicks in"]},
  dislocation:{sym:{1:["Joint out of place, limited movement"],2:["Major joint displaced, visible deformity"]},signs:["💢 Deformity: Bone bulging at joint","🔒 Locked: Can't bend or straighten normally","💜 Swelling: Rapid around joint","⚡ Nerve: Tingling/numbness beyond joint","🫀 Pulse: Check below — dislocation can pinch vessels"],doEx:{1:["/do Their {z} out of socket. Joint locked. Can't straighten."],2:["/do Joint dislocated. Bone bulging wrong. No feeling past it."],3:["/do Joint at {z} wrenched completely out. Bone visibly displaced under the skin. Swelling rapid. Nerve pinched — tingling turning to numbness below."],4:["/do Joint at {z} dislocated with force — bone tearing through surrounding tissue. No pulse below the joint. Limb going cold and white. Nerve and vessel trapped."],5:["/do Joint at {z} destroyed — dislocated with such violence that ligaments are torn, vessels compressed, nerves crushed. Limb below is cold, blue, and dying. Without reduction, the limb is lost."]},rec:["Sling or splint after","Pops out easier next time","Sore with limited range days"],drugs:["Cocaine paste before reset","Leather to bite during","Aspirin after"]},
  snake_bite:{sym:{1:["Two puncture marks, local swelling, mild nausea"],2:["Rapid swelling, dizziness, vomiting"],3:["Venom spreading, breathing difficulty, darkening tissue"]},signs:["🐍 Fang marks: Two punctures spaced apart","💜 Swelling: Rapidly spreading — track the border","🖤 Discoloration: Skin darkening = tissue dying from venom","🫀 Pulse: Rapid/irregular as venom affects heart","🤮 Systemic: Nausea, metallic taste, blurred vision = venom in blood","😵 Breathing: Difficulty = venom affecting respiratory system"],doEx:{1:["/do Two puncture marks on {z}. Red, swelling outward. Mild nausea."],2:["/do Fang marks on {z}, swelling past the joint. Skin darkening. Dizzy, vomiting."],3:["/do Fang marks on {z}. Swelling spreading fast, skin turning black around the bite. Breathing labored. Heart racing."],4:["/do Venom spreading from {z}. Entire area swollen and darkening. Can't breathe properly. Pulse erratic. Drifting in and out. Tissue dying."],5:["/do Massive envenomation from {z}. Limb blackened and dead. Convulsing. Breathing failing. Heart giving out."]},rec:["Watch for tissue death","Tourniquet area monitored","Black skin = necrosis"],drugs:["Aspirin mild, morphine if severe","Treatment mostly venom extraction"]},
  arterial_bleed:{sym:{3:["Bright red spurting with heartbeat, going pale"],4:["Massive spray, minutes from death"]},
    ...
    doEx:{1:["/do Bleeding from {z} that won't fully stop. Dark blood seeping steady. Bruising spreading wider than expected."],2:["/do Blood flowing steadily from {z}. Starting to pulse with the heartbeat — vessel is nicked. Getting lightheaded. Pressure isn't stopping it."],3:["/do Bright red blood spurts from {z} matching heartbeat. Going pale. Pulse weakening."],4:["/do Arterial spray from {z}. Cherry-red, rhythmic. Limb beyond going cold. Going limp."],5:["/do Major artery severed at {z}. Blood spraying with each weakening heartbeat. Pool spreading on the ground. No color left. Eyes unfocused. Seconds matter."]},rec:["Extended bed rest","IV fluids for blood volume","Close to death — weakness, fear, slow rebuild"],drugs:["Ether if surgery, morphine after — both addictive"]},
  eye_injury:{sym:{1:["Eye watering, swollen, blurred vision, light sensitivity"],2:["Blood in eye, severe pain, vision impaired, swelling shut"],3:["Eye lacerated/ruptured, total vision loss that side"]},
    ...
    doEx:{1:["/do Eye swollen, watering. Pupil sluggish to light."],2:["/do Blood pooling in the eye. Pupil won't react. Vision gone that side."],3:["/do Eye ruptured. Clear fluid and blood leaking. Blind that side."],4:["/do Eye destroyed — globe collapsed, fluid and blood running down the cheek. Socket is a ruin. The eye is gone."],5:["/do Both eyes damaged. One or both destroyed. Blood and fluid from the sockets. Total blindness. The world has gone dark."]},rec:["Blindness possible — could be permanent","Depth perception affected with one eye","Bandage during recovery"],drugs:["Cocaine solution to numb","Morphine for severe"]},
  ear_injury:{sym:{1:["Ear torn or bleeding, ringing, muffled hearing"],2:["Eardrum burst — sharp pain, hearing loss, vertigo"],3:["Inner ear destroyed, permanent hearing loss, extreme vertigo"]},
    ...
    doEx:{1:["/do Ear torn, bleeding. Ringing. Can't hear fingers snapping that side."],2:["/do Blood from ear canal. World spinning — can't stand. Nauseous from vertigo."],3:["/do Ear destroyed — cartilage torn, canal collapsed. Blood and fluid pouring. Completely deaf that side. Vertigo so bad they're vomiting."],4:["/do Ear canal crushed. Blood and clear fluid (CSF) leaking — skull may be fractured behind the ear. Total hearing loss. Can't stand, can't focus. World won't stop spinning."],5:["/do Both ears damaged. Blood and brain fluid from the canals. Completely deaf. Balance destroyed — can't sit up without falling. Skull fracture likely. Disoriented, confused, terrified in silence."]},rec:["Hearing loss may be temporary or permanent","Balance problems from inner ear","Tinnitus can be ongoing"],drugs:["Aspirin for mild","Morphine if severe"]},
  jaw_fracture:{sym:{1:["Jaw misaligned, painful, swelling"],2:["Can't close mouth, drooling, slurred speech"],3:["Jaw shattered, teeth loose, severe swelling"]},signs:["🦷 Alignment: Teeth don't line up","🗣️ Speech: Slurred — jaw won't form words","💧 Drooling: Can't close mouth = can't swallow","🦴 Crepitus (bone grinding): Grinding at jaw joint","💜 Swelling: Rapid, may compromise airway if severe"],doEx:{1:["/do Jaw swollen, off-center. Teeth don't line up. Speech painful."],2:["/do Jaw hanging wrong. Can't close mouth. Drooling. Grinding sound."],3:["/do Jaw shattered. Teeth loose and bloody. Can't speak — just moaning through an open, crooked mouth. Swelling closing in fast."],4:["/do Jaw broken in multiple places. Hanging loose, teeth scattered. Blood and saliva pouring. Swelling threatening the airway. Choking on their own blood."],5:["/do Lower face destroyed. Jaw in pieces — bone fragments visible through torn skin. Teeth gone. Can't breathe properly from the blood and swelling. Airway closing. Unrecognizable."]},rec:["Liquids and soft foods only","Speech affected","May need wiring or splinting"],drugs:["Cocaine paste externally","Laudanum drops under tongue"]},
  tooth_damage:{sym:{1:["Tooth chipped/cracked, sharp pain with cold air, blood in mouth"],2:["Tooth knocked out, socket bleeding, gap visible"]},signs:["🦷 Socket: Bleeding from empty socket = fully knocked completely out","🩸 Blood: Steady with saliva","😬 Alignment: Remaining teeth loosened/shifted","⚡ Nerve: Sharp shooting pain with cold/touch = exposed nerve"],doEx:{1:["/do Spits blood. Tonguing cracked tooth. Sharp pain in cold air."],2:["/do Spits out a tooth. Socket bleeding. Jaw tender."],3:["/do Multiple teeth knocked out. Mouth full of blood. Jaw aching. Spitting fragments. Speech garbled through the gaps and swelling."],4:["/do Teeth shattered — roots exposed, nerves screaming. Jaw may be cracked underneath. Blood pouring from multiple empty sockets. Can barely open or close the mouth."],5:["/do Most teeth destroyed — shattered, knocked out, roots exposed. Jaw fractured from the same impact. Mouth is a ruin of blood, bone fragments, and broken enamel. Can't eat, can't speak, can't close the mouth."]},rec:["Missing teeth permanent — no implants","Affects eating, speech, appearance","Gap-toothed grin tells a story"],drugs:["Clove oil or cocaine paste","Laudanum if multiple teeth"]},
  crush_injury:{sym:{1:["Severe bruising, swelling, throbbing"],2:["Bones cracked, skin split, blood blisters, can't use it"],3:["Tissue destroyed, bones pulverized, amputation possible"]},signs:["💜 Swelling: Rapid, massive — tissue filling with blood","🖤 Blood blisters: Large dark blisters = deep damage","⚡ Sensation: Numbness = nerves crushed. Tingling = partial","🫀 Capillary refill (blood flow test): Press nail — should pink in 2 seconds. Slow = blood supply damaged","🦴 Crepitus (bone grinding): Grinding = multiple small bones shattered"],doEx:{1:["/do Their {z} badly swollen, deep purple. Throbbing."],2:["/do Their {z} crushed — skin split, blood blisters. Bones grinding. Can't move it."],3:["/do Their {z} is destroyed — tissue flattened, bones in pieces under the skin. No feeling. Limb going cold."],4:["/do Their {z} is mangled beyond recognition. Bones shattered into fragments. Skin torn open over pulped muscle. No circulation below. Shock setting in."],5:["/do Their {z} is completely destroyed. Nothing left to save. Tissue pulped, bones powder, skin hanging loose. Amputation is the only path."]},
    wDoEx:{hammer:{1:["/do Hammer blow left their {z} deeply bruised and swollen. Skin intact but throbbing. Already turning purple."],2:["/do Hammer caved in their {z}. Skin split from the impact. Bone crunching underneath. Blood blisters forming fast."],3:["/do Repeated hammer blows destroyed their {z}. Bones pulverized. Tissue flattened. Skin split open, dark blood oozing. No feeling left."],4:["/do Their {z} was beaten until the bones gave way. Fragments grinding under the skin. Tissue is dead. Cold and swelling fast. The limb is finished."],5:["/do Hammer obliterated their {z}. Nothing recognizable left — just pulped flesh over powdered bone. Skin hanging in strips. This needs to come off."]}},
    rec:["Crushed digits may need amputation","Permanent dexterity/balance loss possible","Healing slow — deep damage"],drugs:["Morphine for severe","Ether if amputation"]},
  frostbite:{sym:{
      1:["Red, itchy, swollen patches on exposed skin — chilblains","Burning and tingling sensation, worse when warming up","Skin tender and puffy but intact — no blisters yet"],
      2:["Patches turning purple-red and swelling more — worsening chilblains","Intense itching that becomes painful, skin cracking","Small blisters forming on the worst patches, skin peeling"],
      3:["Skin turning white and waxy — true frostbite has set in","Complete numbness — can't feel touch, temperature, or pain","Skin hard to the touch, wooden texture, joints stiff and won't bend"],
      4:["Skin darkening to grey or mottled purple — tissue is dying","Large blood-filled blisters forming as it thaws","Deep, burning pain during rewarming — then nothing as nerves die","Underlying muscle and tendons affected — limb is stiff and useless"],
      5:["Tissue black, hard, and dead — gangrene","Foul smell from decomposing tissue","No feeling, no blood flow, no saving it — amputation required","The black tissue is spreading toward healthy areas"]
    },signs:["🥶 Color progression: Red/puffy (chilblains) → White/waxy (frostbite) → Grey/purple (dying) → Black (dead/gangrene)","👆 Sensation: Itchy/burning (chilblains) → Numb/wooden (frostbite) → Burning during thaw → Nothing (nerves dead)","🧊 Texture: Puffy/swollen (chilblains) → Hard/waxy (frostbite) → Blistered during thaw → Leathery/dry (gangrene)","💜 Blisters: Clear fluid = superficial damage, recoverable. Blood-filled/dark = deep damage, tissue dying","🖤 Gangrene: Black, foul-smelling, dry or weeping = dead tissue, needs surgical removal or amputation","⚠️ CRITICAL: Do NOT apply direct heat (fire, hot water) — burns the frozen tissue. Gradual rewarming ONLY","⚠️ Do NOT rub or massage frostbitten areas — crystals in the tissue shred cells when rubbed","🔄 Refreezing after thawing is WORSE than the original freeze — avoid at all costs"],
    doEx:{1:["/do Red, puffy patches on their {z}. Itching and burning. Skin swollen but intact. Shifts uncomfortably, rubbing at the irritation."],2:["/do Purple-red swelling on their {z}. Skin cracking at the edges. Small blisters weeping clear fluid. Winces when anything touches it."],3:["/do Their {z} is white and waxy. Hard to the touch like wood. No reaction when poked — completely numb. Fingers won't bend. Ice crystals visible under the skin."],4:["/do Their {z} is grey and mottled. Large dark blisters filled with bloody fluid. As warmth reaches it, the pain hits — screaming, then nothing as the nerves give out. Tissue is dying."],5:["/do Their {z} is black and dead. Hard, dry, cracking. Smells of rot. No feeling, no blood flow. A clear line where living tissue meets dead. This needs to come off."]},
    rec:["Chilblains (mild): Keep warm, don't scratch, moisturize. Clears up in 1-3 weeks","Superficial frostbite: Gradual rewarming in lukewarm water. Blisters will form — don't pop them","Deep frostbite: Rewarming is AGONIZING — pain medication essential. May take hours","Black tissue = gangrene = amputation inevitable — the question is where to cut","Nerve damage from frostbite can be permanent — ongoing numbness, tingling, cold sensitivity","The affected area will ALWAYS be more vulnerable to cold going forward","Rewarming pain is one of the worst pains described — strong meds justified"],
    drugs:["Chilblains: Aspirin for inflammation, herbal salve for the skin","Frostbite rewarming: Laudanum or morphine — the thaw pain is severe","Gangrene/amputation: Ether for surgery, morphine post-op — addiction risk with prolonged treatment","Clove oil topical for burning/itching in chilblains stage"]},
  strangulation:{sym:{1:["Sore throat, hoarse voice, red marks on neck, coughing"],2:["Bruising around throat, raspy/whispery voice, difficulty breathing","Bloodshot eyes, petechiae (tiny red dots from burst blood vessels on face/eyes)"],3:["Crushed windpipe — can barely or can't breathe at all","Face dark red/purple, eyes bulging, losing consciousness"]},
    ...
    doEx:{1:["/do Red marks across throat. Voice hoarse. Coughing. Tender to touch."],2:["/do Bruising around throat — finger-shaped marks. Voice barely a whisper. Tiny red dots on face and in whites of eyes. Struggling to breathe."],3:["/do Throat crushed. Can barely get air. Face dark red. Eyes bloodshot, bulging. Fading."],4:["/do Windpipe collapsed. No air getting through. Face purple, swollen. Eyes bulging, blood vessels burst across the whites. Unconscious. Dying of asphyxiation."],5:["/do Neck crushed. Trachea destroyed. No breathing. Face black-purple, eyes hemorrhaged. No pulse. If cervical spine fractured — no movement below the neck."]},rec:["Even 'minor' strangulation can swell hours later and close airway","Voice may take days to weeks to return","Swallowing painful for days","This is an assault — lawman component here"],drugs:["Aspirin for swelling","Morphine if windpipe damage severe","Belladonna may help airway inflammation"]},
  ...
  amputation:{sym:{1:["Fingertip or toe severed — bloody, raw stump, sharp stinging pain","Bleeding steady but not arterial — controllable with pressure"],2:["Finger, toe, or partial hand/foot lost — bone visible in the stump","Significant bleeding, throbbing pain, the severed piece may be nearby"],3:["Hand, foot, or portion of limb severed below the elbow or knee","Heavy bleeding — arterial if larger vessels caught. Shock developing","Staring at the stump in disbelief, not yet processing what's happened"],4:["Limb or digit severed or so destroyed it must be removed","Catastrophic bleeding from the stump — bright arterial spurts","Immediate shock — pale, cold, clammy, pulse racing then fading","The severed part may still be twitching — nerves firing independently"],5:["Complete traumatic loss — limb torn away by force","Massive hemorrhage, tissue hanging, bone exposed","Consciousness fading rapidly — minutes without a tourniquet"]},
    signs:["✂️ Stump: Bone visible, vessels spurting (arterial = bright red, rhythmic), muscle retracted","🩸 Bleeding: CATASTROPHIC — tourniquet is the difference between life and death","😰 Shock: Immediate and severe — the body's blood pressure plummets","⚡ Phantom sensation: Patient may 'feel' the missing limb — nerves still firing at the stump","🦴 Bone: May be protruding, shattered, or filed smooth (if surgical). Jagged = traumatic","🧊 Temperature: Remaining stump may be cold if blood supply compromised","💜 Color: Stump skin going dark = tissue dying from poor blood supply","🫀 Pulse: Rapid and thready — body compensating for massive blood loss","🧠 Mental: Dissociation common — patient may not believe what's happened, eerily calm, or screaming"],
    doEx:{1:["/do Fingertip gone. Raw, bloody stump. Bone just visible at the tip. Bleeding steady. Staring at the missing piece in shock, not yet feeling the full pain."],2:["/do Finger severed at the knuckle. Bone protruding from the stump. Blood dripping steady. The detached piece on the ground nearby. Hand shaking uncontrollably."],3:["/do Their {z} ends in a ragged stump below the joint. Bone visible, muscle retracted. Blood pulsing from severed vessels. Face white. Hasn't looked down yet — or can't stop looking."],4:["/do Their {z} is gone — severed above the joint. Bone visible in the ragged stump. Blood spurting in rhythmic pulses. Skin white as parchment. Shaking violently."],5:["/do What's left of their {z} is a ruin of torn muscle and shattered bone. Blood everywhere. Eyes glassy, barely conscious. The severed piece lies nearby."]},
    rec:["This is PERMANENT — your character has lost a part of themselves","Stump care is daily: cleaning, petroleum jelly, fresh bandages","Phantom limb pain is real and can be played out — feeling the missing fingers, an itch you can't scratch","Prosthetic fitting after healing: wooden peg, hook, mechanical hand depending on location","Balance and movement change fundamentally — a missing leg means crutches or prosthetic, missing arm means one-handed everything","The psychological impact is enormous — grief, anger, depression, identity crisis are all natural reactions","Recovery is 48-72h minimum bed rest, then weeks of rehabilitation","This is a character-defining moment — how they cope shapes who they become"],
    drugs:["Ether — MUST be unconscious for surgical amputation","Morphine — severe, prolonged pain. Highly addictive. Up to 24h recovery","Laudanum — ongoing pain management during weeks of healing","Phantom pain may require ongoing medication — addiction risk is very real","The combination of pain, grief, and opioid use makes addiction RP very natural here"]},
  animal_bite:{sym:{1:["Tooth punctures, moderate bleeding, bruised"],2:["Deep bite, torn skin, heavy bleeding, bruising spreading"],3:["Flesh torn away, muscle visible, heavy blood loss"],4:["Mauling — multiple deep bites, tissue ripped away, shock"],5:["Devastating mauling — limb mangled, massive blood loss, barely alive"]},
    signs:["🐺 Tooth marks: Puncture pattern shows the animal's jaw shape","🩸 Bleeding: Bites crush AND tear — both blunt and cutting damage","🤒 Infection: Almost guaranteed — animal mouths carry bacteria","💜 Bruising: Jaw pressure crushes tissue around the punctures","⚠️ Rabies risk: Wild animal? Foaming? Acting strange? Time-sensitive"],
  ...
  scalping:{sym:{1:["Partial scalp torn — flap of skin and hair pulled back, heavy bleeding"],2:["Large section of scalp peeled away — skull bone visible underneath"],3:["Most of the scalp removed — exposed skull, massive blood loss, shock"],4:["Complete scalp removal — bare skull, patient barely conscious, catastrophic bleeding"],5:["Scalped and left for dead — skull exposed, dried blood, infection already starting, near death"]},
    ...
    rec:["⚠️ DEFINITIVE TREATMENT REQUIRES A CERTIFIED GENERAL SURGEON","Field medics and regular doctors can ONLY stabilize — stop bleeding, cover the wound, treat shock","Do NOT attempt to reattach or graft scalp tissue without surgical certification","FIELD STABILIZATION: Direct pressure to stop bleeding, clean cloth over exposed skull, petroleum jelly to keep bone moist, treat for shock","SURGICAL TREATMENT (General Surgeon only): Scalp reattachment if flap is viable, skin grafting from thigh or back if scalp is lost, debridement of dead bone, wound closure","If the scalp is gone, keep the exposed skull moist at all times — dry bone dies (osteonecrosis) and crumbles, exposing the brain","Infection is the long-term killer — exposed skull leads to bone death without surgical skin coverage","Recovery is months. Skin grafting, constant wound care, permanent disfigurement","This is a defining character moment — survival itself is remarkable","Permanent scarring — no hair will regrow on grafted areas"],
  ...
  black_eye:{sym:{1:["Eye area tender, slight puffiness, faint reddening"],2:["Visible bruise around the socket, eye partially swollen but still open"],3:["Swollen nearly shut, deep purple discoloration spreading"],4:["Eye fully swollen shut, dark purple-black mass from brow to cheekbone"],5:["Both eyes swollen shut, face is a purple ruin, skin split from the swelling itself"]},
  ...
  split_lip:{sym:{1:["Small split on the lip, minor bleeding, mild swelling"],2:["Lip clearly split open, blood running, lip puffing up noticeably"],3:["Deep split, heavy bleeding, lip swollen to twice normal size, talking impaired"],4:["Lip torn badly in multiple places, teeth loosened, blood pouring, can't close mouth"],5:["Lower face devastated, lips torn open, teeth broken or missing, jaw may be cracked underneath"]},
  ...
  bloody_nose:{sym:{1:["Light trickle from one nostril, easily controlled with pressure"],2:["Steady drip from both nostrils, soaking through a cloth quickly"],3:["Heavy flow, swallowing blood, gagging, nausea from the metallic taste"],4:["Won't stop after 15+ minutes of pressure, soaked through multiple cloths, dizzy"],5:["Persistent hemorrhage despite all attempts — something deep is torn, dangerous blood loss"]},
...
function Body({back,markers,act,onClick}){
  ...
  var hnd=function(e){var svg=ref.current;if(!svg)return;var pt=svg.createSVGPoint();pt.x=e.clientX;pt.y=e.clientY;var sp=pt.matrixTransform(svg.getScreenCTM().inverse());var cx=(sp.x-15)/1.09,cy=sp.y/1.09;var b=null,bd=99;vis.forEach(function(z){var zx=mx(z);var d=Math.hypot(cx-zx,cy-z.y);if(d<z.r+16&&d<bd){b=z;bd=d;}});if(b)onClick(b,cx,cy);};
  return(
    <svg ref={ref} viewBox="0 0 300 510" onClick={hnd} className="cg-body-svg">
      ...
      <g transform="translate(15,0) scale(1.09)">
        {back
      ...
      {markers.map(function(m,i){var z=Z.find(function(zn){return zn.id===m.zid;});if(!z)return null;var cx=mx(z),cy=z.y;return React.createElement("g",{key:i},React.createElement("circle",{cx:cx,cy:cy,r:16,fill:"url(#hg)"},React.createElement("animate",{attributeName:"r",values:"14;20;14",dur:"2s",repeatCount:"indefinite"})),React.createElement("circle",{cx:cx,cy:cy,r:8,fill:i===act?"#cd853f":"#b22222",stroke:"#fff",strokeWidth:"1.5",filter:"url(#gl)"}),React.createElement("text",{x:cx,y:cy+3,textAnchor:"middle",fontSize:"9",fontWeight:"bold",fill:"#fff",fontFamily:"Georgia"},i+1));})}
      </g>
...
const P=({children,style})=>{const T=useContext(ThemeCtx)||THEME_LIGHT;return <p style={{margin:"0 0 3px",fontSize:12,lineHeight:1.5,color:T.text,...style}}>{children}</p>;};
const Code=({children})=>{const T=useContext(ThemeCtx)||THEME_LIGHT;return <div style={{background:T.bg==="#faf3e8"?"rgba(107,143,60,0.08)":"rgba(107,143,60,0.15)",borderRadius:6,padding:"7px 11px",marginBottom:4,fontFamily:"'Courier New',monospace",fontSize:12,color:T.text,lineHeight:1.45,whiteSpace:"pre-wrap"}}>{children}</div>;};
function Sec({title,color,children,open:init=true}){const T=useContext(ThemeCtx)||THEME_LIGHT;const[o,sO]=useState(init);return(<div style={{marginBottom:11}}><button onClick={()=>sO(!o)} style={{background:"none",border:"none",cursor:"pointer",display:"flex",alignItems:"center",gap:5,padding:0,width:"100%",textAlign:"left"}}><span style={{fontFamily:"'Playfair Display',Georgia,serif",fontSize:13.5,fontWeight:"bold",color:color||T.text}}>{o?"▾":"▸"} {title}</span></button>{o&&<div style={{marginTop:4,paddingLeft:9,borderLeft:"3px solid "+(color||T.border)}}>{children}</div>}</div>);}
function AnatP({zone,T:Tp}){const T=Tp||useContext(ThemeCtx)||THEME_LIGHT;if(!zone)return null;const s=zone.sev,c=s>=4?"#b22222":s>=3?"#cd6600":s>=2?"#b8860b":"#6b8f3c";return(<div style={{background:T.sectionBg,border:"1px solid "+T.borderLight,borderRadius:7,padding:"8px 10px",marginBottom:8}}><div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:3}}><h4 style={{fontFamily:"'Playfair Display',Georgia,serif",fontSize:13,margin:0,color:T.text}}>{zone.label}</h4><span style={{background:c,color:"#fff",padding:"1px 7px",borderRadius:10,fontSize:9,fontWeight:"bold",whiteSpace:"nowrap"}}>Danger: {s>=4?"Critical":s>=3?"High":s>=2?"Moderate":"Low"}</span></div><P style={{fontSize:11,fontStyle:"italic",color:T.textSecondary,marginBottom:3}}>{zone.desc}</P><div style={{display:"flex",flexWrap:"wrap",gap:2}}>{zone.anat.map((a,i)=><span key={i} style={{background:"rgba(178,34,34,0.06)",border:"1px solid rgba(178,34,34,0.1)",borderRadius:10,padding:"1px 6px",fontSize:10,color:T.textSecondary}}>{a}</span>)}</div></div>);}

function SevBadge({type,zone,weapon}){
  var T=useContext(ThemeCtx)||THEME_LIGHT;
  ...
  return React.createElement("div",{style:{marginTop:5,display:"flex",alignItems:"center",gap:4,flexWrap:"wrap"}},
    React.createElement("span",{style:{fontSize:9.5,color:T.textMuted}},"Severity:"),
    ...
    React.createElement("span",{style:{fontSize:8.5,color:T.textFaint}},si.ic),
...
function IllOut({illKey}){
  ...
  var il=ILL[illKey];
  if(!il) return null;
  return React.createElement("div",{style:{marginBottom:14,paddingBottom:14,borderBottom:"1px dashed "+T.border}},
...
function ConseqOut({zid,sev}){
  ...
  return React.createElement(Sec,{title:"\uD83E\uDD20 Living With It — Practical Consequences",color:"#8b6914"},
    ...
    React.createElement(P,{style:{fontStyle:"italic",fontSize:10.5,color:T.textFaint}},"Suggestions, not rules — pick what fits your character.")
  );
}

function CombinedOut({injuries,effSev}){
  var T=useContext(ThemeCtx)||THEME_LIGHT;
  var combo=getCombined(injuries,Z);
  if(!combo||!injuries||injuries.length<2) return null;
  var si=SV[Math.min(Math.max(effSev,1),5)-1]||SV[0];
  return React.createElement("div",{style:{background:"rgba(139,34,34,.04)",border:"2px solid rgba(178,34,34,.2)",borderRadius:10,padding:"12px 13px",marginTop:12,marginBottom:8}},
    React.createElement("h3",{style:{fontFamily:"'Playfair Display',Georgia,serif",fontSize:14,margin:"0 0 8px",color:"#8b2222"}},"\u26A0 Combined Injury Effects"),
    React.createElement(P,{style:{fontSize:11.5,fontWeight:"bold",color:si.c,marginBottom:6}},"Overall: "+si.l+" \u2014 "+injuries.length+" injuries compounding"),
    combo.map(function(item,j){return React.createElement(P,{key:j,style:{fontSize:12,marginBottom:6,paddingLeft:8,borderLeft:"3px solid rgba(178,34,34,.2)"}},item);}),
    React.createElement(P,{style:{fontSize:10.5,fontStyle:"italic",color:T.textMuted,marginTop:6}},"Use what fits your character and the scene.")
  );
}

// ── JOURNAL TAB ──
function JournalTab({onJump}){
  const T=useContext(ThemeCtx)||THEME_LIGHT;
  ...
  return(<div>
    <div style={{display:"flex",gap:6,marginBottom:10,flexWrap:"wrap"}}>
      <input value={search} onChange={e=>setSearch(e.target.value)} placeholder="Search injuries & illnesses..." style={{flex:1,minWidth:160,padding:"8px 10px",borderRadius:6,border:"1px solid "+T.border,background:T.inputBg,fontFamily:"Georgia,serif",fontSize:13,color:T.text}}/>
      {["all","injuries","illnesses"].map(f=><button key={f} onClick={()=>setFilter(f)} style={{padding:"6px 12px",borderRadius:8,border:"1px solid "+T.border,background:filter===f?T.text:"transparent",color:filter===f?T.headerText:T.textMuted,fontSize:11,fontWeight:"bold",cursor:"pointer",fontFamily:"Georgia,serif",textTransform:"capitalize"}}>{f}</button>)}
    </div>
    <P style={{fontSize:11,color:T.textMuted,fontStyle:"italic",marginBottom:10}}>Click any entry to expand it. Full details from the State of Monroe Medical SOP.</P>
    <div style={{display:"flex",flexDirection:"column",gap:4}}>
      {filtered.map(j=>{
        const isOpen=expanded===j.id;
        const d=j.data;
        return(<div key={j.id} style={{border:"1px solid "+(isOpen?T.accent:T.borderLight),borderRadius:8,background:isOpen?T.activeBg:T.sectionBg,overflow:"hidden",transition:"all 0.15s"}}>
          <button onClick={()=>setExpanded(isOpen?null:j.id)} style={{width:"100%",padding:"10px 12px",background:"none",border:"none",cursor:"pointer",display:"flex",alignItems:"center",gap:8,textAlign:"left"}}>
            ...
            <span style={{fontFamily:"'Playfair Display',Georgia,serif",fontSize:14,fontWeight:"bold",color:T.text,flex:1}}>{j.label}</span>
            <span style={{fontSize:10,color:T.textMuted,background:T.sectionBg,padding:"2px 8px",borderRadius:10,textTransform:"capitalize"}}>{j.type}</span>
            <span style={{fontSize:12,color:T.textMuted}}>{isOpen?"▾":"▸"}</span>
          </button>
          {isOpen&&(<div style={{padding:"0 12px 12px",borderTop:"1px solid "+T.borderLight}}>
      ...
      {!filtered.length&&<P style={{textAlign:"center",color:T.textMuted,fontStyle:"italic",padding:20}}>No results found for "{search}"</P>}
    </div>
  </div>);
}
...
const QREF = [
  ...
  { title:"💊 Drugs & Substances Guide", items:[
    {name:"Mota (Cannabis / Marijuana)", desc:"Dried plant, smoked or eaten. Used recreationally and medicinally for pain, anxiety, sleep, and appetite. Common among frontier folk — grows wild in some areas. Not physically addictive but can become a habit.",
      doHint:"/do Eyes are red and half-lidded. Moves slowly, almost dreamily. Smells like skunk and dried herbs. Giggles at nothing. Ravenously hungry.",
      extra:"EFFECTS: Relaxation, euphoria, slowed reaction time, increased appetite, mild pain relief, drowsiness. Higher doses cause paranoia or anxiety.\nADDICTION: Low. Psychological habit rather than physical dependence. No dangerous withdrawal.\nSIGNS OF USE: Red/glassy eyes, slow speech, giggly or spacey demeanor, smells of pungent herbs, eating everything in sight.\nWITHDRAWAL: Irritability, trouble sleeping, decreased appetite. Uncomfortable but not dangerous."},
    {name:"Cocaine (Coca Extract)", desc:"White powder derived from coca leaves. Snorted, rubbed on gums, or dissolved in drinks. Period-accurate — widely available in patent medicines, even in Coca-Cola. Used medically as a local anesthetic (especially dental and nasal work). Highly stimulating and extremely addictive.",
      doHint:"/do Wired. Talking fast, jumping between subjects. Eyes wide, pupils huge. Jaw clenching. Can't sit still — pacing, fidgeting. Rubbing their nose constantly.",
      extra:"EFFECTS: Intense energy, euphoria, confidence, rapid speech, decreased appetite, numbed pain. Short-lived (30-60 min), then crash. Heart races dangerously.\nADDICTION: Very High. Psychological craving is overwhelming. Tolerance builds fast — need more each time.\nSIGNS OF USE: Dilated pupils, rapid speech, restlessness, jaw grinding, sniffling/nosebleeds (if snorted), overconfidence, paranoia at higher doses, sweating.\nWITHDRAWAL: Deep depression, exhaustion, intense cravings, agitation, sleeping for days. Not physically dangerous but psychologically devastating.\nMEDICAL USE: Topical anesthetic — cocaine paste numbs skin before surgery. Legitimate in 1890s medicine."},
    {name:"Heroin (Diamorphine)", desc:"Derived from morphine, sold as a 'non-addictive' morphine substitute in the 1890s (it's far worse). Injected, smoked, or taken as powder. Produces intense euphoria followed by a warm, drowsy state. One of the most addictive substances known.",
      doHint:"/do Pupils are pinpoints. Eyelids heavy, nodding off mid-sentence. A dreamy half-smile. Scratching absently at their arms. Movements slow like they're underwater. Completely unbothered by everything.",
      extra:"EFFECTS: Intense rush of euphoria, warmth spreading through the body, pain completely gone, extreme drowsiness ('nodding'), nausea (especially first use), slowed breathing, constipation.\nADDICTION: Extreme. Physical dependence develops within days of regular use. The body needs it to function normally.\nSIGNS OF USE: Pinpoint pupils, nodding off, slurred speech, drowsy/dreamy state, track marks on arms (injection), weight loss, neglecting hygiene, scratching/itching.\nWITHDRAWAL: Brutal. Starts 6-12 hours after last dose. Sweating, shaking, vomiting, diarrhea, muscle cramps, bone-deep aching, insomnia, restless legs, goosebumps ('cold turkey'), desperate craving. Feels like dying but rarely fatal. Lasts 5-7 days peak.\nMEDICAL USE: Originally marketed as a cough suppressant and morphine substitute. Period-accurate availability."},
    {name:"Phenacetin (Pain Powder)", desc:"White powder taken orally, dissolved in water or as tablets. Common over-the-counter pain and fever reducer in the 1890s. Milder than morphine — comparable to modern aspirin/Tylenol but with more side effects. Not recreationally abused but overuse damages kidneys.",
      doHint:"/do Took a powder for the pain. Seems more comfortable. Slightly flushed. Mentions it tastes bitter.",
      extra:"EFFECTS: Pain relief (mild to moderate), fever reduction, mild sense of well-being. Takes 30-60 min to work. Lasts several hours.\nADDICTION: Low. Not recreationally addictive. However, chronic overuse develops as patients rely on it for daily pain.\nSIGNS OF USE: No dramatic signs — patient simply has less pain and lower fever. Skin may flush slightly blue-gray with chronic overuse (methemoglobinemia).\nWITHDRAWAL: Headache and return of pain. No dangerous physical withdrawal.\nDANGERS: Chronic overuse destroys the kidneys. Blue-gray skin discoloration. Blood disorders with prolonged use. The 'safe' option that isn't safe long-term."},
    {name:"Morphine (Opium Extract)", desc:"The gold standard painkiller of the 1890s. Injected, taken as liquid (laudanum = morphine in alcohol), or as pills. Derived from opium poppies. Extremely effective for severe pain. Extremely addictive. 'Soldier's disease' — Civil War veterans addicted from battlefield medicine.",
      doHint:"/do Pupils are tiny. Pain is gone — completely at ease despite the injury. Drowsy, drifting. Speech slow and thick. Scratching at their skin absently. A faint smile even through the worst of it.",
      extra:"EFFECTS: Complete pain elimination, euphoria, deep relaxation, drowsiness, nausea, constipation, slowed breathing. The standard against which all painkillers are measured.\nADDICTION: Very High. Physical dependence develops within 1-2 weeks of regular use. Tolerance builds fast — same dose stops working, need more.\nSIGNS OF USE: Pinpoint pupils, drowsiness, slurred speech, constipation, itching/scratching, nodding off, calm demeanor inappropriate to situation, track marks if injected.\nWITHDRAWAL: Severe. Similar to heroin but slightly less intense. Sweating, vomiting, diarrhea, muscle cramps, restlessness, insomnia, yawning, runny nose/eyes, goosebumps, irritability, desperate cravings. Peak at 48-72 hours, subsides over 7-10 days.\nMEDICAL USE: Post-surgery, severe trauma, terminal illness. Laudanum (liquid form) prescribed freely — even for children's teething pain in this era.\nRP NOTE: 'Soldier's disease' is a rich backstory element. Many characters in this era would have morphine dependence from medical treatment."},
  ]},
...
function QuickRefTab(){
  ...
  return(<div>
    <P style={{fontSize:11,color:T.textMuted,fontStyle:"italic",marginBottom:10}}>Quick-lookup cards for describing injuries in /do and /me. Tap a category to expand.</P>
    <div style={{display:"flex",flexDirection:"column",gap:5}}>
      {QREF.map((cat,ci)=>{
        const isOpen=open===ci;
        return(<div key={ci} style={{border:"1px solid "+(isOpen?T.accent:T.borderLight),borderRadius:8,background:isOpen?T.activeBg:T.sectionBg,overflow:"hidden"}}>
          <button onClick={()=>setOpen(isOpen?null:ci)} style={{width:"100%",padding:"10px 12px",background:"none",border:"none",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"space-between",textAlign:"left"}}>
            <span style={{fontFamily:"'Playfair Display',Georgia,serif",fontSize:14,fontWeight:"bold",color:T.text}}>{cat.title}</span>
          ...
          {isOpen&&<div style={{padding:"0 12px 12px",borderTop:"1px solid "+T.borderLight}}>
            {cat.items.map((item,ii)=>(
              <div key={ii} style={{padding:"8px 0",borderBottom:ii<cat.items.length-1?"1px solid rgba(196,168,130,.3)":"none"}}>
                ...
                <P style={{fontSize:11.5,color:T.textSecondary}}>{item.desc}</P>
                {item.doHint&&<Code>{item.doHint}</Code>}
                {item.extra&&<div style={{marginTop:5,background:"rgba(61,43,31,.04)",borderRadius:5,padding:"6px 8px",border:"1px solid rgba(196,168,130,.2)"}}>
                  {item.extra.split("\n").map((line,li)=>{
                    const parts=line.split(":");
                    const label=parts[0];
                    const rest=parts.slice(1).join(":");
                    return <P key={li} style={{fontSize:11,marginBottom:3}}><span style={{fontWeight:"bold",color:T.text}}>{label}:</span><span style={{color:T.textSecondary}}>{rest}</span></P>;
                  })}
                </div>}
              </div>
            ))}
...
// ═══════════════════════════════════════════════════════════════════════════════
// ═══════════════════════════════════════════════════════════════════════════════
// CAUSE CATEGORIES — simplify injury selection
// ═══════════════════════════════════════════════════════════════════════════════
const CAUSES = [
...
// ═══════════════════════════════════════════════════════════════════════════════
const THEME_LIGHT = {
  bg:"#faf3e8",bgAlt:"#efe3d0",bgCard:"#fff9f0",bgHover:"rgba(205,133,63,.08)",
  text:"#3d2b1f",textMuted:"#8b7355",textSecondary:"#5c4033",textFaint:"#a08968",
  border:"#c4a882",borderLight:"#ddd0bc",accent:"#cd853f",
  headerBg:"linear-gradient(180deg,#3d2b1f,#5c4033)",headerText:"#f4e8d1",headerMuted:"#c4a882",
  footerBg:"#3d2b1f",
  inputBg:"#faf3e8",
  sectionBg:"rgba(61,43,31,.02)",
  activeBg:"rgba(205,133,63,.08)",activeBorder:"#cd853f",
};
const THEME_DARK = {
  bg:"#171210",bgAlt:"#1e1914",bgCard:"#221d18",bgHover:"rgba(205,133,63,.12)",
  text:"#e2d5c4",textMuted:"#9a8b7a",textSecondary:"#bfad9a",textFaint:"#6b5e50",
  border:"#4a3d2f",borderLight:"#3a3028",accent:"#cd853f",
  headerBg:"linear-gradient(180deg,#0d0a07,#171210)",headerText:"#f4e8d1",headerMuted:"#8b7355",
  footerBg:"#0d0a07",
  inputBg:"#1e1914",
  sectionBg:"rgba(244,232,209,.04)",
  activeBg:"rgba(205,133,63,.15)",activeBorder:"#cd853f",
};
...
export default function App(){
  ...
  const zLabel=(z)=>z?(bk&&z.bl?z.bl:z.label):"—";
  const[tab,setTab]=useState("injuries");
  const[dark,setDark]=useState(()=>{try{return localStorage.getItem("cg-theme")==="dark";}catch(e){return false;}});
  const[cause,setCause]=useState(null);
  const T=dark?THEME_DARK:THEME_LIGHT;
  const toggleTheme=useCallback(()=>{setDark(d=>{const n=!d;try{localStorage.setItem("cg-theme",n?"dark":"light");}catch(e){}return n;});},[]);
  ...
  return(<ThemeCtx.Provider value={T}><div style={{minHeight:"100vh",background:T.bg,fontFamily:"Georgia,serif",color:T.text,transition:"background .3s,color .3s"}}>
    <div style={{background:T.headerBg,padding:"18px 12px 14px",textAlign:"center",borderBottom:"4px solid "+T.border,position:"relative"}}>
      ...
      <button onClick={toggleTheme} style={{position:"absolute",top:8,right:12,background:dark?"rgba(250,243,232,.15)":"rgba(61,43,31,.12)",border:"2px solid "+(dark?"rgba(244,232,209,.4)":"rgba(61,43,31,.25)"),borderRadius:12,padding:"8px 16px",cursor:"pointer",color:T.headerText,fontSize:18,zIndex:2,fontWeight:"bold",transition:"all .2s",display:"flex",alignItems:"center",gap:6}} title={dark?"Switch to light mode":"Switch to dark mode"}>{dark?"☀️":"🌙"}<span style={{fontSize:11,fontFamily:"Georgia,serif"}}>{dark?"Light":"Dark"}</span></button>
      <h1 style={{fontFamily:"'Playfair Display',Georgia,serif",fontSize:21,color:T.headerText,margin:0,letterSpacing:2,textTransform:"uppercase",fontWeight:900}}>⚕ Casualty's Field Guide ⚕</h1>
      <p style={{color:T.headerMuted,fontSize:10,margin:"3px 0 0",letterSpacing:3,textTransform:"uppercase"}}>Ranch Roleplay — State of Monroe</p>
      <div style={{background:"rgba(244,232,209,.12)",border:"1px solid rgba(196,168,130,.3)",borderRadius:8,padding:"10px 16px",margin:"10px auto 6px",maxWidth:520}}>
        <p style={{color:T.headerText,fontSize:13,margin:"0 0 4px",fontWeight:"bold",fontFamily:"Georgia,serif"}}>⚕ This is your RP starting point — not a script.</p>
        <p style={{color:T.headerMuted,fontSize:11,margin:0,lineHeight:1.5,fontStyle:"italic"}}>Click where you're hurt. Pick what happened. Get a scene you can RP — plain language, no med school needed.</p>
      </div>
      <p style={{color:T.textFaint,fontSize:8.5,margin:"6px 0 0",fontStyle:"italic"}}>Created by Sr. Dr. Thomas 'Tommy' Denholme — MMO — Chief of Neurology, M.D., Ph.D., DMSc., FRCS</p>
    </div>

    <div style={{display:"flex",background:T.bgAlt,borderBottom:"2px solid "+T.border}}>
      {[["injuries","🩸 Injuries"],["illness","🤒 Illness"],["journal","📖 Journal"],["quickref","🔍 Quick Ref"]].map(([k,l])=>
        <button key={k} onClick={()=>setTab(k)} style={{flex:1,padding:"8px 0",background:tab===k?T.bg:"transparent",border:"none",borderBottom:tab===k?"3px solid "+T.accent:"3px solid transparent",color:tab===k?T.text:T.textMuted,fontFamily:"Georgia,serif",fontSize:12.5,fontWeight:tab===k?"bold":"normal",cursor:"pointer",transition:"background .2s,color .2s"}}>{l}</button>
      )}
      <button onClick={function(){window.open("https://forms.gle/wMmBdaa6wKjFpo49A","_blank");}} style={{flex:1,padding:"8px 0",background:"transparent",border:"none",borderBottom:"3px solid transparent",color:"#b22222",fontFamily:"Georgia,serif",fontSize:12.5,fontWeight:"bold",cursor:"pointer"}}>📝 Feedback</button>
    </div>

    <div style={{padding:"12px 10px 80px"}}>
      {tab==="injuries"?(<div className="cg-layout">
        <div className="cg-paperdoll">
            <div style={{display:"flex",gap:3,marginBottom:5}}>{[["Front",false],["Back",true]].map(([l,v])=><button key={l} onClick={()=>setBk(v)} style={{padding:"4px 14px",borderRadius:10,border:"1px solid "+T.border,background:bk===v?T.text:"transparent",color:bk===v?T.headerText:T.textMuted,fontSize:11,fontWeight:"bold",cursor:"pointer",fontFamily:"Georgia,serif"}}>{l}</button>)}</div>
            ...
            {injs.map((inj,i)=>{const zone=Z.find(z=>z.id===inj.zid);const avail=zone?gzi(zone):[];const isA=act===i;
              ...
              return(<div key={i} onClick={()=>setAct(i)} style={{background:isA?T.activeBg:T.sectionBg,border:"2px solid "+(isA?T.activeBorder:T.borderLight),borderRadius:9,padding:"9px 10px",cursor:"pointer",transition:"all .15s"}}>
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:5}}>
                  <span style={{fontFamily:"'Playfair Display',Georgia,serif",fontWeight:"bold",fontSize:12.5,color:T.text}}><span style={{display:"inline-flex",alignItems:"center",justifyContent:"center",width:17,height:17,borderRadius:"50%",background:"#b22222",color:"#fff",fontSize:9.5,fontWeight:"bold",marginRight:4}}>{i+1}</span>{zLabel(zone)}</span>
                ...
                {inj.type&&canHaveIntDmg(inj.type)&&(
                  <select value={inj.intDmg||""} onChange={e=>{setInjs(p=>p.map((x,j)=>j===i?{...x,intDmg:e.target.value,intSev:e.target.value?Math.max(inj.intSev||0,1):0}:x));}} onClick={e=>e.stopPropagation()} style={{...sel,marginTop:4,borderColor:inj.intDmg?"#8b2222":"#c4a882"}}>
                    <option value="">— Internal damage? (optional) —</option>
                    {getAvailIntDmg(inj.zid).map(d=><option key={d.id} value={d.id}>{d.l}</option>)}
                  </select>
                )}
                {inj.intDmg&&(
                  <div style={{display:"flex",gap:2,marginTop:4}}>{INT_SEV.map(s=>
                    <button key={s.v} onClick={e=>{e.stopPropagation();setInjs(p=>p.map((x,j)=>j===i?{...x,intSev:s.v}:x));}} style={{flex:1,padding:"4px 0",border:"2px solid "+(inj.intSev===s.v?s.c:"transparent"),borderRadius:5,background:inj.intSev===s.v?s.c:T.sectionBg,color:inj.intSev===s.v?"#fff":T.textMuted,cursor:"pointer",fontSize:9,fontWeight:"bold",fontFamily:"Georgia,serif"}}>{s.l}</button>
                  )}</div>
                )}
                {inj.type&&IT[inj.type]&&<SevBadge type={inj.type} zone={zone} weapon={inj.weapon}/>}
              </div>);
            })}
            {injs.length>0&&injs.length<3&&<P style={{fontSize:9.5,color:T.textMuted,fontStyle:"italic",textAlign:"center"}}>Click body to add another ({injs.length}/3)</P>}
          {val.length>0&&<div style={{marginBottom:12}}>
            <div style={{display:"flex",alignItems:"center",gap:5,marginBottom:4}}><span style={{fontSize:11.5,fontWeight:"bold",color:T.text}}>Overall Severity:</span><span style={{background:SV[eff-1].c,color:"#fff",padding:"1px 8px",borderRadius:10,fontSize:10,fontWeight:"bold"}}>{SV[eff-1].l}</span><span style={{fontSize:10,color:"#cd6600",fontWeight:"bold"}}>IC: {SV[eff-1].ic}</span><span style={{fontSize:10,color:T.text,fontWeight:"bold",textDecoration:"underline"}}>OOC: {SV[eff-1].ooc}</span>{oSv&&<button onClick={()=>setOSv(null)} style={{background:"none",border:"none",color:T.textMuted,cursor:"pointer",fontSize:9.5,fontStyle:"italic",textDecoration:"underline"}}>Reset</button>}</div>
            <div style={{display:"flex",gap:2}}>{SV.map(s=><button key={s.v} onClick={()=>setOSv(s.v===sug?null:s.v)} style={{flex:1,padding:"3px 0",border:"2px solid "+(s.v===eff?s.c:"transparent"),borderRadius:5,background:s.v<=eff?s.c:T.sectionBg,color:s.v<=eff?"#fff":T.textMuted,cursor:"pointer",fontSize:9,fontWeight:"bold",fontFamily:"Georgia,serif",opacity:s.v<=eff?1:.4}}>{s.l}</button>)}</div>
            <P style={{fontSize:9,color:T.textFaint,fontStyle:"italic"}}>Suggested: {SV[sug-1].l}. Click to adjust.</P>
          </div>}
        </div>
        <div className="cg-guide">
      {has&&tab==="injuries"&&(<div style={{background:T.bgCard,border:"2px solid "+T.border,borderRadius:12,padding:"14px 11px",boxShadow:"0 2px 8px rgba(61,43,31,.06)"}}>
        <h2 style={{fontFamily:"'Playfair Display',Georgia,serif",fontSize:17,margin:"0 0 10px",paddingBottom:8,borderBottom:"2px solid "+T.border,color:T.text}}>📋 Your Scene Guide</h2>
        {val.length>1&&<div style={{background:"rgba(178,34,34,.04)",borderRadius:7,padding:"7px 9px",marginBottom:10,border:"1px solid rgba(178,34,34,.1)"}}><P style={{fontWeight:"bold",color:SV[eff-1].c}}>Multiple Injuries — {SV[eff-1].l}</P><P style={{fontSize:11,fontStyle:"italic",color:T.textSecondary}}>With {val.length} injuries, compound effects add depth. Doc will likely triage the most dangerous first.</P></div>}
        ...
        {val.map((inj,i)=>{const zone=Z.find(z=>z.id===inj.zid);const data=OD[inj.type];if(!data||!zone)return null;
          ...
          const idmg=getIntDmg(inj.intDmg);const iSev=inj.intSev||0;
          const sv=Math.min(5,Math.max(1,(IT[inj.type]&&IT[inj.type].bs||1)+(zone.sev||0)+(wm&&wm.sevMod||0)+(idmg&&iSev>=3?1:0)));const si=SV[Math.min(Math.max(sv,1),5)-1]||SV[0];
          const syms=gfs(data.sym||{},sv)||[];const wCat=wm?wm.id:null;const doSrc=(wCat&&data.wDoEx&&data.wDoEx[wCat])?data.wDoEx[wCat]:(data.doEx||{});const dos=(gfs(doSrc,sv)||[]).map(x=>(x||"").replace(/\{z\}/g,zone.label.toLowerCase()));
          const intEffects=idmg&&iSev?idmg.effects[Math.min(iSev,5)]||[]:[];
          const isNerve=inj.intDmg==="nerve";
          const isFracture=["fracture_hairline","fracture_linear","fracture_comminuted"].includes(inj.type);
          return(<div key={i} style={{marginBottom:10,border:"1px solid "+T.border,borderRadius:10,overflow:"hidden"}}>
            <div style={{background:T.activeBg,padding:"8px 11px",borderBottom:"1px solid "+T.border,position:"sticky",top:0,zIndex:1}}>
              <div style={{display:"flex",alignItems:"center",gap:5,flexWrap:"wrap"}}><span style={{fontSize:15}}>{IT[inj.type]&&IT[inj.type].i}</span><span style={{fontFamily:"'Playfair Display',Georgia,serif",fontSize:14,fontWeight:"bold",color:T.text}}>{IT[inj.type]&&IT[inj.type].l}</span>{wm&&<span style={{fontSize:11,color:"#556b2f",fontWeight:"bold"}}>({getGunName(inj.weapon)||wm.cat})</span>}{idmg&&<span style={{fontSize:11,color:"#8b2222",fontWeight:"bold"}}>+ {idmg.l}</span>}<span style={{fontSize:10.5,color:T.textMuted}}>— {zone.label}</span><span style={{background:si.c,color:"#fff",padding:"1px 6px",borderRadius:10,fontSize:9,fontWeight:"bold"}}>{si.l}</span></div>
              <div style={{display:"flex",gap:8,marginTop:3,fontSize:10}}><span style={{color:"#cd6600",fontWeight:"bold"}}>IC: {si.ic}</span><span style={{color:T.text,fontWeight:"bold",textDecoration:"underline"}}>OOC: {si.ooc}</span></div>
            </div>
            <div style={{overflowY:"auto",padding:"10px 11px"}}>

            {/* Lethality warning — keep, it's critical */}
            ...
            <div style={{background:T.sectionBg,borderRadius:6,padding:"8px 10px",marginBottom:8,borderLeft:"3px solid "+si.c}}>
              <P style={{fontSize:10,fontWeight:"bold",color:si.c,marginBottom:2}}>What it looks like:</P>
              {(syms||[]).map((s,j)=><P key={j} style={{fontSize:12}}>• {s}</P>)}
            </div>

            {/* Internal damage — brief */}
            {idmg&&iSev>0&&<div style={{background:"rgba(139,34,34,.04)",borderRadius:6,padding:"6px 9px",marginBottom:8,border:"1px solid rgba(139,34,34,.12)"}}>
              <P style={{fontSize:10.5,fontWeight:"bold",color:"#8b2222"}}>🩻 {idmg.l} — {INT_SEV[iSev-1].l}</P>
              {intEffects.slice(0,2).map((e,j)=><P key={j} style={{fontSize:11}}>• {e}</P>)}
              {isNerve&&<P style={{fontSize:10.5,color:T.textMuted,fontStyle:"italic",marginTop:3}}>🧠 Nerve damage needs a neurologist — your doc should refer you.</P>}
            </div>}

            {/* Fracture one-liner */}
            {isFracture&&<div style={{background:T.sectionBg,borderRadius:6,padding:"6px 9px",marginBottom:8,border:"1px solid "+T.borderLight}}>
              <P style={{fontSize:11}}>🦴 {inj.type==="fracture_hairline"?"Cracked but holding together — splint it, don't move it.":inj.type==="fracture_linear"?"Snapped clean — needs to be set straight and held in a cast.":"Shattered — bone in pieces. Surgery, pins, or possible amputation."}</P>
            </div>}

            {/* /do examples — the core value */}
            <Sec title="📝 /do Examples" color="#6b8f3c" open={true}>
              {(dos||[]).map((x,j)=><Code key={j}>{x}</Code>)}
              <P style={{fontSize:10,fontStyle:"italic",color:T.textMuted}}>Copy, tweak, make it yours.</P>
            </Sec>
            ...
            <div style={{background:T.sectionBg,borderRadius:6,padding:"6px 9px",marginBottom:4,border:"1px solid "+T.borderLight}}>
              <P style={{fontSize:10.5,fontWeight:"bold",color:"#cd6600"}}>🩹 Recovery</P>
              <P style={{fontSize:11}}>{si.d}</P>
              <P style={{fontSize:10,fontStyle:"italic",color:T.textMuted}}>Follow your doc's lead. Check the Journal tab for full recovery details.</P>
            </div>
        ...
        {val.length>=2&&<CombinedOut injuries={val} effSev={eff}/>}

        <div style={{background:T.sectionBg,borderRadius:7,padding:"9px 11px",marginTop:10,border:"1px solid "+T.borderLight}}>
          <h3 style={{fontFamily:"'Playfair Display',Georgia,serif",fontSize:12.5,margin:"0 0 5px",color:T.textSecondary}}>💡 Tips & Ideas</h3>
          <P style={{fontSize:11,color:T.text}}>• <strong>Let the doc lead.</strong> Use /do to describe what they'd see — not what they should do.</P>
          <P style={{fontSize:11,color:T.text}}>• <strong>Small reactions go a long way.</strong> A flinch, gritting teeth, going quiet — try what feels right for your character.</P>
          <P style={{fontSize:11,color:T.text}}>• <strong>Recovery is RP gold.</strong> A limp, a sling, wincing when you reach — these details create follow-up scenes.</P>
          <P style={{fontSize:11,color:T.text}}>• <strong>The game tracks addiction.</strong> Laudanum, morphine, cocaine — in-game addiction may kick in.</P>
          <P style={{fontSize:11,color:T.text}}>• <strong>Infection is a story.</strong> Skip follow-ups or keep wounds dirty? That's your next doc visit.</P>
          <P style={{fontSize:11,color:T.text}}>• <strong>The doc decides recovery time.</strong> Times here are SOP guidelines. Trust their call.</P>
          <P style={{fontSize:11,color:T.text}}>• <strong>None of this is mandatory.</strong> Use what works, ignore the rest.</P>
        </div>
      </div>)}
      {!has&&tab==="injuries"&&!injs.length&&<div style={{textAlign:"center",padding:"28px 14px",color:T.textMuted}}><p style={{fontSize:26,margin:"0 0 6px"}}>⚕</p><P style={{fontSize:13,fontStyle:"italic",color:T.textMuted}}>Click anywhere on the figure to get started.</P><P style={{fontSize:10.5,color:T.textFaint}}>A starting point for casualty RP — not a rulebook.</P></div>}
      </div>
      </div>):tab==="illness"?(<div>
        ...
        {ill&&ILL[ill]&&<IllOut illKey={ill}/>}
        {!ill&&<div style={{textAlign:"center",padding:"28px 14px",color:T.textMuted}}><p style={{fontSize:26,margin:"0 0 6px"}}>🤒</p><P style={{fontSize:13,fontStyle:"italic",color:T.textMuted}}>Select an illness above to see symptoms, /do examples, and RP guidance.</P></div>}
      </div>):tab==="quickref"?(<QuickRefTab/>):(<JournalTab/>)}
    </div>
    <div style={{background:T.footerBg,padding:"12px 16px",textAlign:"center",borderTop:"2px solid "+T.border}}>
      <p style={{color:T.textMuted,fontSize:8.5,margin:0,fontFamily:"Georgia,serif",fontStyle:"italic"}}>Created by Sr. Dr. Thomas 'Tommy' Denholme — MMO — Chief of Neurology, M.D., Ph.D., DMSc., FRCS</p>
      <p style={{color:T.textFaint,fontSize:7.5,margin:"3px 0 0"}}>State of Monroe Medical Office — Ranch Roleplay — www.ranchroleplay.com</p>
    </div>
